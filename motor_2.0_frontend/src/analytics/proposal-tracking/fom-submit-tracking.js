...
export const _submitTracking = (type, temp_data, enquiry_id, data, vehicle) => {
  if (we_track && temp_data) {
    ...
    let addonsData =
      applicableAddon && applicableAddon?.length
        ...
        : "";
    we_track.track("Motor Insurance Application Submitted", {
      ...
      "Add Ons": addonsData,
      "IDV Value": idv,
      "Total Premium Payable": finalPremiumAmount,
