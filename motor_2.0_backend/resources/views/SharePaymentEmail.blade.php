...
<head>
	...
	<title>Comparepolicy - Compare Car Insurance Policy</title>
</head>
<body>
							...
							<tr>
								<td align="left" colspan="2" style="padding:0" valign="top">
									<table align="left" border="0" cellpadding="0" cellspacing="0" width="100%">
										<tbody>
											<tr>
												<td style="text-align:left;padding:10px 0px 12px 30px" valign="bottom" width="100%"><a href="https://www.comparepolicy.com/?utm_medium=email#term" style="text-decoration:none;outline:none"><img src="https://www.comparepolicy.com/cp/welcome-emails/images/cp-logo.png" title="ComparePolicy.com" width="160" /> </a></td>
											</tr>
										</tbody>
									</table>
								</td>
																				...
																				<td align="left" colspan="2" style="background:#ffffff;font:normal 15px 'Lato','Helvetica Neue',Helvetica,Tahoma,Arial,sans-serif;color:#314451;text-align:left;color:#314452;line-height:1.3em;padding:20px" valign="top">
																					<div style="margin: 40px 40px;">
																						...
																						<div style="padding: 0px 10px;">
																							...
																							<p style="font-size: 0.85rem;">Continue your proposal on Compare Policy by clicking
																								<br>
																							...
																							<p style="margin-top: 30px;font-size: 0.85rem;font-weight: bold;letter-spacing: 0.3px;">For any assistance, please feel free to connect with our customer care at our toll free number 1800-12000-0055 or drop an e-mail at <a href="#">support@comparepolicy.com</a></p>
																							<div style="display: flex;flex-direction: column;margin-top: 60px;">
																								<span>Yours Sincerely,</span>
																								<strong style="color: darkblue;">Compare Policy Team</strong>
																							</div>
																						</div>
																				</td>
																			</tr>
