                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    <div class="form-check">
                                        <label class="form-check-label">
                                            <input type="checkbox" class="form-check-input check-all"  name="permission[]" value="pos.agents">
                                            POS Agents
                                        </label>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="form-check">
                                        <label class="form-check-label">
                                            <input type="checkbox" class="form-check-input check-all"  name="permission[]" value="frontend_constants.list">
                                            Frontend Constants
                                        </label>
                                    </div>
                                </div>
                               ...
                               <div class="col-md-3">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="form-check">
                                            <label class="form-check-label">
                                                <input type="checkbox" class="form-check-input check-all" name="permission[]" value="configurator.pos-imd">
                                        ...
                                        <div class="form-check">
                                            <label class="form-check-label">
                                                <input type="checkbox" class="form-check-input check-all" name="permission[]" value="configurator.payment_gateway">
