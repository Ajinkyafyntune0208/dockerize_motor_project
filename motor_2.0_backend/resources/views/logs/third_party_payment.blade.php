@extends('layout.app', ['activePage' => 'log-third-party-payment', 'titlePage' => __('Third Party Payment Logs')])
@section('content')
<div class="content-wrapper">
    <div class="row">
        <div class="col-lg-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Third Party Payment Logs</h4>
                    @error('error')
                        ...
                        <div class="row mb-3">
                            <div class="col-sm-3">
                                <div class="form-group">
                                    ...
                                    <input id="enquiry_id" name="enquiry_id" type="text" value="{{ old('enquiry_id', request()->enquiry_id) }}" class="form-control" placeholder="Enquiry Id" required>
