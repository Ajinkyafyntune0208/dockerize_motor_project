@extends('admin_lte.layout.app', ['activePage' => 'fetch-all-masters', 'titlePage' => __('Fetch All Masters')])
...
<div class="card">
    <div class="card-header">
        ...
        <div class="button text-center" style="display: none;"><button class="btn btn-primary" id="sync-all-masters" onclick="syncAllMasters(this)" type="button">Sync All Masters</button></div>
        </div>
    </div>
    <div class="card-body">
