@extends('admin_lte.layout.app', ['activePage' => 'activity-logs', 'titlePage' => __('Activity Logs')])
@section('content')
            ...
            <div class="row">
                ...
                <div class="col-sm-3">
                    <div class="form-group">
                        ...
                        <select name="type[]" multiple data-actions-box="true" class="select2 form-control w-100" required>
