        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="contrainer">
                    <form action="{{ route('admin.ic-error-handling.store') }}" method="post" class="row"
                        enctype="multipart/form-data">@csrf
                        <div class="col-md-4">
                            <div class="form-group">
                                <label class="active" for="label">Select Excel File <span class="text-danger">*</span></label>
                                <br>
                        ...
                        <div class="col-md-4">
                            <div class="d-flex justify-content-left">
                                <button type="submit" style="margin-left: 500px" class="btn btn-outline-primary">Submit</button>
                            </div>
                        </div>
                </div>
                </form>
                <a class="btn btn-primary" href="{{url('Sample IC Error Format.xlsx')}}">Download Excel File Format</a>
            </div>
            </div>
