...
<main class="container-fluid">
    <section class="mb-4">
        <div class="card">
            <div class="card-body">
            <a href="{{ url()->previous() }}" class="btn btn-sm btn-primary mb-3"><i class="fa fa-arrow-circle-left"></i> Back</a><br>
            <div class="form-group">
                <form action="{{ route('admin.ic-error-handling.update',[$edit_data->id, 'type' => request()->type]) }}" method="post">@csrf @method('PUT')
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                <label>Company Name<span class="text-danger">*</span></label>
                                    ...
                                    class="form-control select2" data-live-search="true" disabled>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                            <label class="required">Section<span class="text-danger">*</span></label>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label class="required">Section Type<span class="text-danger">*</span></label>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <Label class="required">IC Error<span class="text-danger">*</span></Label>
                                <textarea disabled style="height: 10rem;" class = "form-control" name="ic_error" rows = "3" placeholder="Please Enter IC Error..." >{{$edit_data->ic_error}}</textarea>
                                @error('message')<span class="text-danger">{{ $message }}</span>@enderror
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <Label class="required">Custom Error<span class="text-danger">*</span></Label>
                    ...
                    <div class="d-flex justify-content-around">
                        <div class="col-md-3">
                            <div class="d-flex align-items-center h-100">
                                <input type="submit" value= "Update" class="btn btn-outline-primary btn-md w-100">
                            </div>
                        </div>
                    </div>
                    <div class="row">
