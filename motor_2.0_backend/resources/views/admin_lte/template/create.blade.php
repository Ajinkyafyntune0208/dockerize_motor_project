    ...
    <div class="card card-primary">
        ...
        <div class="card-body">
            <form action="{{ route('admin.template.store') }}" method="POST">@csrf
                    ...
                    <div class="col-sm-10">
                        <div class="dropdown input-group">
                            ...
                            <input type="text" class="form-control" placeholder="Alias" aria-label="alias" id="alias"
                                name="alias" readonly value="{{ old('alias') }}">
                ...
                <div class="form-group row" style="display: flex; flex-direction: row; align-items: center;">
                    <label for="communication_type" class="col-sm-2 col-form-label required">Communication <br> Type</label>
                    <div class="col-sm-10">
                        ...
                        <select name="communication_type" data-style="btn-sm btn-primary"data-actions-box="true"
                            ...
                            <option value="email" {{ old('communication_type') == 'email' ? 'selected' : '' }}>
                                Email</option>
                            <option value="sms" {{ old('communication_type') == 'sms' ? 'selected' : '' }}>
                                SMS</option>
                            <option value="whatsapp" {{ old('communication_type') == 'whatsapp' ? 'selected' : '' }}>
                                Whatsapp
                            </option>
                        </select>
                ...
                <div class="form-group row" style="display: flex; flex-direction: row; align-items: center;"
                    ...
                    <div class="col-sm-10">
                        <select name="message_type" data-style="btn-sm btn-primary" data-actions-box="true"
                            ...
                            <option value="">Nothing Selected</option>
                            <option value="Plane Text" {{ old('message_type') == 'Plane Text' ? 'selected' : '' }}>Plane
                                text</option>
...
@section('scripts')
    ...
    <script>
        ...
        function communicationTypeOption(communication_type) {
            ...
            if (($('#alias').val() == 'Global Header' || $('#alias').val() == 'Global Footer') && communication_type ==
                "email") {
                $('#global_header_field').hide();
                $('#footer_field').hide();
                $('#message_type_field').hide();
