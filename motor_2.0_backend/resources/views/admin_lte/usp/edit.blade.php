                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('admin.usp.update', [ $id, 'usp_type' => request()->usp_type ]) }}" method="post">@csrf @method('PUT')
                            <div class="form-group">
                                ...
                                <select name="ic_alias" class="select2 form-control w-100 @error('ic_alias') is-invalid @enderror" data-style="btn-primary" data-live-search="true" required>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="usp_desc" class="form-control @error('usp_desc') is-invalid @enderror" placeholder="USP Desc" value="{{ old('usp_desc', $usp->usp_desc) }}" required maxlength="255">
