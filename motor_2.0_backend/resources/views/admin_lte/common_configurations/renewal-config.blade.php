@include('admin_lte.common_configurations.renewal-attempt-config')


<div class="card mt-3">   
    <div class="card-header">
        <h3 class="card-title">Renewal Configurator</h3>
    </div>
    <div class="card-body">
        @php
        ...
        @endphp
         <form action="{{ route('admin.common-config-save') }}" method="POST" class="mt-3 renewalConfig">
            ...
            <table class="table table-striped col-sm-12 renewal-config-table">
                <thead>
                    <tr>
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="checkbox" name="data[renewalConfig.online.idv.edit][value]" {{ ($allData['renewalConfig.online.idv.edit'] ?? '') == "Y" ? 'checked' : '' }}>
                        </td>
                        <td>
                            ...
                            <input type="checkbox" name="data[renewalConfig.online.ncb.edit][value]" {{ ($allData['renewalConfig.online.ncb.edit'] ?? '') == "Y" ? 'checked' : '' }}>
                        </td>
                        ...
                        <td>
                            ...
                            <input type="checkbox" name="data[renewalConfig.online.claim.edit][value]" {{ ($allData['renewalConfig.online.claim.edit'] ?? '') == "Y" ? 'checked' : '' }}>
                        </td>
                        ...
                        <td>
                            ...
                            <input type="checkbox" name="data[renewalConfig.online.proposal.edit][value]" {{ ($allData['renewalConfig.online.proposal.edit'] ?? '') == "Y" ? 'checked' : '' }}>
                        </td>
                        ...
                        <td>
                            ...
                            <input type="checkbox" name="data[renewalConfig.online.ownership.edit][value]" {{ ($allData['renewalConfig.online.ownership.edit'] ?? '') == "Y" ? 'checked' : '' }}>
                        </td>
                        ...
                        <td>
                            ...
                            <input type="checkbox" name="data[renewalConfig.offline.icFetch.idv.edit][value]" {{ ($allData['renewalConfig.offline.icFetch.idv.edit'] ?? '') == "Y" ? 'checked' : '' }}>
                        </td>
                        <td>
                            ...
                            <input type="checkbox" name="data[renewalConfig.offline.icFetch.ncb.edit][value]" {{ ($allData['renewalConfig.offline.icFetch.ncb.edit'] ?? '') == "Y" ? 'checked' : '' }}>
                        </td>
                        ...
                        <td>
                            ...
                            <input type="checkbox" name="data[renewalConfig.offline.icFetch.claim.edit][value]" {{ ($allData['renewalConfig.offline.icFetch.claim.edit'] ?? '') == "Y" ? 'checked' : '' }}>
                        </td>
                        ...
                        <td>
                            ...
                            <input type="checkbox" name="data[renewalConfig.offline.icFetch.proposal.edit][value]" {{ ($allData['renewalConfig.offline.icFetch.proposal.edit'] ?? '') == "Y" ? 'checked' : '' }}>
                        </td>
                        ...
                        <td>
                            ...
                            <input type="checkbox" name="data[renewalConfig.offline.icFetch.ownership.edit][value]" {{ ($allData['renewalConfig.offline.icFetch.ownership.edit'] ?? '') == "Y" ? 'checked' : '' }}>
                        </td>
                    </tr>
                    <tr>
                        <td></td>
                        ...
                        <td>
                            ...
                            <input type="checkbox" name="data[renewalConfig.offline.vahan.idv.edit][value]" {{ ($allData['renewalConfig.offline.vahan.idv.edit'] ?? '') == "Y" ? 'checked' : '' }}>
                        </td>
                        <td>
                            ...
                            <input type="checkbox" name="data[renewalConfig.offline.vahan.ncb.edit][value]" {{ ($allData['renewalConfig.offline.vahan.ncb.edit'] ?? '') == "Y" ? 'checked' : '' }}>
                        </td>
                        ...
                        <td>
                            ...
                            <input type="checkbox" name="data[renewalConfig.offline.vahan.claim.edit][value]" {{ ($allData['renewalConfig.offline.vahan.claim.edit'] ?? '') == "Y" ? 'checked' : '' }}>
                        </td>
                        ...
                        <td>
                            ...
                            <input type="checkbox" name="data[renewalConfig.offline.vahan.proposal.edit][value]" {{ ($allData['renewalConfig.offline.vahan.proposal.edit'] ?? '') == "Y" ? 'checked' : '' }}>
                        </td>
                        ...
                        <td>
                            ...
                            <input type="checkbox" name="data[renewalConfig.offline.vahan.ownership.edit][value]" {{ ($allData['renewalConfig.offline.vahan.ownership.edit'] ?? '') == "Y" ? 'checked' : '' }}>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="checkbox" name="data[renewalConfig.offline.clientData.idv.edit][value]" {{ ($allData['renewalConfig.offline.clientData.idv.edit'] ?? '') == "Y" ? 'checked' : '' }}>
                        </td>
                        <td>
                            ...
                            <input type="checkbox" name="data[renewalConfig.offline.clientData.ncb.edit][value]" {{ ($allData['renewalConfig.offline.clientData.ncb.edit'] ?? '') == "Y" ? 'checked' : '' }}>
                        </td>
                        ...
                        <td>
                            ...
                            <input type="checkbox" name="data[renewalConfig.offline.clientData.claim.edit][value]" {{ ($allData['renewalConfig.offline.clientData.claim.edit'] ?? '') == "Y" ? 'checked' : '' }}>
                        </td>
                        ...
                        <td>
                            ...
                            <input type="checkbox" name="data[renewalConfig.offline.clientData.proposal.edit][value]" {{ ($allData['renewalConfig.offline.clientData.proposal.edit'] ?? '') == "Y" ? 'checked' : '' }}>
                        </td>
                        ...
                        <td>
                            ...
                            <input type="checkbox" name="data[renewalConfig.offline.clientData.ownership.edit][value]" {{ ($allData['renewalConfig.offline.clientData.ownership.edit'] ?? '') == "Y" ? 'checked' : '' }}>
                        </td>
                    </tr>
                </tbody>
            </table>
