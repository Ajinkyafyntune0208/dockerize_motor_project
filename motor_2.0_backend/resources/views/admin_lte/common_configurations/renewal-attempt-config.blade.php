<div class="card mt-3">
    <div class="card-header">
        <h3 class="card-title">Renewal Attempts Configurator</h3>
    </div>
    <div class="card-body">
        <form action="{{ route('admin.common-config-save') }}" method="POST" class="mt-3 renewalAttemptConfig">
            ...
            <div class="row">
                ...
                <div class="col-12 mt-3">
                    ...
                    <table class="table table-striped col-sm-12 apiConfigClass mt-1 fetchIterationTable">
                        <thead>
                            <tr>
                                <th>Iterations</th>
            ...
            <div class="row mt-5">
                ...
                <div class="col-12 mt-3">
                    <h6 class=""><u>Interval configuration : </u></h6>
                    <table class="table table-striped col-sm-12 apiConfigClass mt-1 vahanIterationTable">
                        <thead>
                            <tr>
                                <th>Iterations</th>
                                <th>Intervals (in minutes)</th>
