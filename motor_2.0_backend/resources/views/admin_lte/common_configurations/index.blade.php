@extends('admin_lte.layout.app', ['titlePage' => 'Common Configurations'])
@section('content')
    <style>
        select {
            text-align: center;
            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="form-group">
                        <label for="idv">IDV setting</label>
                        <select name="data[idv][value]" id="idv" data-actions-box="true" class="select2 form-control w-100" data-live-search="true" onChange=buttonHide()>
...
<div class="card">
    <div class="card-header">
        <h3 class="card-title">Slack Configurations</h3>
    </div>
    <div class="card-body">
            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <input id="enableSlack" type="checkbox" name="data[is_slack_enabled][value]" {{ ($allData['slack.notification.isEnabled'] ?? '') == "Y" ? 'checked' : '' }} onChange=buttonHide()>
            ...
            <div class="row">
                <div class="col-sm-3">
                    <div class="form-group">
                        ...
                        <input id="enableFailedJob" type="checkbox" name="data[enable_failed_job_notification][value]" {{ ($allData['slack.failedJob.enabled'] ?? '') == 'Y' ? 'checked' : '' }} onChange=buttonHide()>
            ...
            <div class="row">
                <div class="col-sm-3">
                    <div class="form-group">
                        ...
                        <input id="enableKafkaFailedValidation" type="checkbox" name="data[kafka_failed_validation][value]" {{ ($allData['slack.kafkaFailedValidation.enable'] ?? '') == 'Y' ? 'checked' : '' }} onChange=buttonHide()>
            ...
            <div class="row">
                <div class="col-sm-3">
                    <div class="form-group">
                        ...
                        <input id="enableIcTimeOutNotification" type="checkbox" name="data[IcTimeoutNotification.isEnabled][value]" {{ ($allData['slack.IcTimeoutNotification.isEnabled'] ?? '') == 'Y' ? 'checked' : '' }} onChange=buttonHide()>
...
<div class="card">   
    <div class="card-header">
        <h3 class="card-title">API TimeOut Configurations (All value will be considered in seconds)</h3>
    </div>
    <div class="card-body">
        <form action="{{ route('admin.common-config-save') }}" method="POST" class="mt-3 apiTimeOutForm" onsubmit="processForm(this)">
            ...
            <div class="row mt-3">
                <div class="col-sm-4">
                    <div class="form-group">
                        ...
                        <input id="enableAutoscaleTimeout" type="checkbox" name="data[global.timeout.autoScale.isEnabled][value]" {{ ($allData['global.timeout.autoScale.isEnabled'] ?? '') == "Y" ? 'checked' : '' }}>
            ...
            <div class=""><br><br>
                <h6 class="text-center"><u>IC Wise configuration</u></h6><br>
                <table class="table table-striped col-sm-12 apiConfigClass">
                    <thead>
                        <tr>
...
@include('admin_lte.common_configurations.renewal-config')

@include('admin_lte.common_configurations.loading-config')

@include('admin_lte.common_configurations.mongo-connection')

@include('admin_lte.common_configurations.policy-wating-time-config')
@endsection
@section('scripts')
    <script>
        function buttonHide(){
