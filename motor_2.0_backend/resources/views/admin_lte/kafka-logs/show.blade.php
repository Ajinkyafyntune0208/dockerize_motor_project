            ...
            <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h4 class="card-title mt-2">Kafka Logs Request Details</h4>

                        @if(!empty($logsDetails) && $logsDetails->enquiryId != "")
                        <a class="btn btn-danger ml-4" title='Back' href='{{ url('admin/kafka-logs') . '?enquiryId=' . $logsDetails->enquiryId }}'>
                            Back</a>
                        @endif
