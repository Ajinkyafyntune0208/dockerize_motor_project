        ...
        <div class="col-sm-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <h5 class="mt-4">Proposal Validation
                        <button id ="reset" class="view btn btn-outline-primary btn-sm" style="float:right">Reset</button>
                    </h5>
                    <form id="addPorp" method="POST">
                        ...
                        <div class="row">
                            <div class="col-12 col-sm-6 form-group">
                                ...
                                <select  data-style="btn-sm btn-primary" data-actions-box="true" class="selectpicker w-100 form-control" data-live-search="true" id="selectIC" name="selectIC" required>
                            ...
                            <div class="col-12 col-sm-6 form-group">
                                ...
                                <select data-style="btn-sm btn-primary" data-actions-box="true" class="selectpicker w-100 form-control" data-live-search="true" id="journeytype" required>
                    ...
                    <div class="mt-2">
                        <p class="alert alert-danger">Note : Regex for allowing only (Alpha-Numeric or Numeric) characters : <strong>^(?=.*\d)[a-zA-Z0-9]+$</strong></p>
                    </div>
                </div>
            </div>
        </div>
