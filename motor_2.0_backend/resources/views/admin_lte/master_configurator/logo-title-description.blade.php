...
<script>
    const existingData = @json($titlExistingData);
    console.log(existingData.value.generic);
    
    document.addEventListener('DOMContentLoaded', function() {
    document.getElementById('genericTitle').value = existingData.value.generic.title;
    document.getElementById('genericDescription').value = existingData.value.generic.description;

    document.getElementById('carTitle').value = existingData.value.car.title;
    document.getElementById('carDescription').value = existingData.value.car.description;

    document.getElementById('bikeTitle').value = existingData.value.bike.title;
    document.getElementById('bikeDescription').value = existingData.value.bike.description;

    document.getElementById('cvTitle').value = existingData.value.cv.title;
    document.getElementById('cvDescription').value = existingData.value.cv.description;
});
</script>
