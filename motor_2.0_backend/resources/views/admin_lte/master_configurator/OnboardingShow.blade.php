...
<div class="content">
        ...
        <div class="col-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <h5 class="mt-3"><b>Onboarding Config </b></h5>
                    ...
                    @if (!isset($error))
                        ...
                        <form  action="{{route('admin.onboardingConfig-store',['broker'=>$bname])}}" method="POST" id="mybrokerform" class="form-submit">
                            ...
                            <h4 class="form-tab">Registration Page</h4>
                            <div class="row">
                                <div class="col-lg-6 col-xl-4">
                                    <div class="py-2 chkbox-cus">
                                        <input
                                        type="checkbox"
                                        name="preventRegistrationAutoSubmit"
                                        id="preventRegistrationAutoSubmit"
                                        name="preventRegistrationAutoSubmit"
                                        value=true
                                        {{($data['preventRegistrationAutoSubmit'] ?? '') ? 'checked' : ''}}
                                        >
                                        <label for="preventRegistrationAutoSubmit" class="form-check-label">
                                            Prevent Registration Auto Submit
                                        </label>
                                    </div>
                                    ...
                                    <div class="col-xl-4 col-lg-6 col-md-12 col-sm-12 col-12">
                                        <div class="d-flex align-items-center">
                                            <div class="py-2">
                                                ...
                                                <select name="fileConfigIC[]" id="fileConfigIC" data-style="btn-cus-v2" data-live-search="true" data-actions-box="true"class="selectpicker w-100 form-control"  aria-required="true" multiple required>
                                                    @foreach ($comp as $dat )
                                        ...
                                        <div class="col-xl-4 col-lg-6 col-md-12 col-sm-12 col-12">
                                            <!-- <div class="py-2"> -->
                                                ...
                                                <select name="maxFileSize" id="maxFileSize" data-style="btn-cus-v2"
                                                    ...
                                                    class="selectpicker w-100 form-control" aria-required="true">
    ...
    @include('admin_lte.master_configurator.broker-logo')
    @include('admin_lte.master_configurator.broker-scripts')
    @include('admin_lte.master_configurator.logo-title-description')
    @include('admin_lte.master_configurator.broker-redirection-url')
    @include('admin_lte.master_configurator.journey-configurator')
    @php
