@extends('admin_lte.layout.app', ['activePage' => 'user', 'titlePage' => __('Data Push Logs')])
@section('content')
        ...
        <form  action="" method="get">
            ...
            <div class="row">
                ...
                <div class="col-sm-3 d-flex align-items-center">
                    <button type="submit" id="submit" class="btn btn-primary mt-3"><i class="fa fa-search m-1"></i> Search</button>
                </div>
