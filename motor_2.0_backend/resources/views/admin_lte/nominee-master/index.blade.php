@extends('admin_lte.layout.app', ['activePage' => 'nominee-master', 'titlePage' => __('Nominee Relationship')])
@section('content')
<div class="row">
          <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Add Nominee Relationship</h3>
                </div>
                <div class="card-body">
                    <form action="{{ route('admin.nominee-master.store', rand()) }}" enctype="multipart/form-data"
                                    method="post">@csrf
                        <div class="row mb-2">
                            <div class="col-sm-3">
                    ...
                    <a class="btn btn-primary" href="{{route('admin.nominee-master.create')}}">Download Excel File Format</a>
                </div>
            </div>
            </div>
          ...
          <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Nominee Relationship List</h3>
                </div>
                <div class="card-body">
