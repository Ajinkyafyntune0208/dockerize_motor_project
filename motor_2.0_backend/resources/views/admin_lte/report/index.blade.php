@extends('admin_lte.layout.app', ['activePage' => 'policy-report', 'titlePage' => __('Policy Report')])
@section('content')
<div class="card">
    <div class="card-body">
        <form action="" method="get">
            <div class="row">
                @can('policy_report.show')
                <div class="col-md-12">
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group w-100">
                                <label>Broker Name</label>
                                <select name="broker_url" id="broker_url" class="select2 w-100 form-control" data-live-search="true">
                                    <option value="">Nothing selected</option>
                                    @foreach($borker_details as $borker_detail)
                                    {{$borker_detail->backend_url}}
                        ...
                        <div class="col-md-4">
                            <div class="form-group w-100">
                                ...
                                <select name="view" id="view" class="select2 w-100 form-control" data-live-search="true">
                                    <option value="">Nothing selected</option>
                        ...
                        <div class="col-md-4">
                            <div class="form-group w-100">
                                <label>Master Company</label>
                                    <select name="master_company[]" multiple data-style="btn btn-primary" data-actions-box="true" class="selectpicker w-100" data-live-search="true">
                ...
                <div class="col-md-2">
                    <div class="form-group">
                        ...
                        <select name="transaction_stage[]" multiple data-style="btn btn-primary" data-actions-box="true" class="selectpicker w-100" data-live-search="true">
                ...
                <div class="col-md-2">
                    <div class="form-group">
                        ...
                        <select name="product_type[]" multiple data-style="btn btn-primary" data-actions-box="true" class="selectpicker w-100" data-live-search="true">
                ...
                <div class="col-md-2">
                    <div class="form-group">
                        ...
                        <select name="seller_type" class="select2 form-control w-100" data-live-search="true">
                            <option value="">Nothing selected</option>
                            ...
                            <option value = "Partner" {{ request()->seller_type == 'Partner' ? 'selected' : '' }}>PARTNER</option>
                            <option value = "b2c" {{ request()->seller_type == 'b2c' ? 'selected' : '' }}>B2C</option>
                        </select>
                    </div>
                </div>
                <div class="col-md-2">
        ...
        <table class="table table-striped" id="policy_reports">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ $report['encrypted_trace_id'] ?? $report['trace_id'] }}</td>
