@extends('layout.app', ['activePage' => 'logs', 'titlePage' => __('Vahan Service Logs')])
@section('content')
    <div class="content-wrapper">
        <div class="row">
            <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Vahan Service Logs</h4>
                            ...
                            <div class="row mb-3">
                                <div class="col-sm-3">
                                    <div class="form-group" >
                                        ...
                                        <select name="type" data-style="btn-sm btn-primary" data-actions-box="true" class="selectpicker w-100" data-live-search="true" id="findUsing" required>
