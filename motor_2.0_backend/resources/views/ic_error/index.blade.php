@extends('layout.app', ['activePage' => 'IC Error Handler', 'titlePage' => __('IC Error Handler')])
...
<main class="container-fluid">
    <section class="mb-4">
        <div class="card">
            <div class="card-body">
                <h5 class="card-title">IC Error Handler</h5>
                @if (session('status'))
                        ...
                        <div class="row">
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <select name="company_alias" id="company_alias" data-style="btn-primary btn-sm" required class="selectpicker w-100" data-live-search="true">
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <select name="type" id="type" data-style="btn-primary btn-sm" required class="selectpicker w-100" data-live-search="true">
                                        <option value="" selected>Select Any One</option>
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    <Label>Status</Label>
                                    <select name="status" id="status" data-style="btn-primary btn-sm" required class="selectpicker w-100" data-live-search="true">
                                        <option value="" selected>Select Any One</option>
                            ...
                            <div class="col-md-3">
                                <div class="d-flex align-items-center h-100">
                                    <input type="submit" class="btn btn-outline-info btn-sm w-75">
                                </div>
                            </div>
                        </div>
                    </form>
                                    ...
                                    <td scope="col" class="text-right">
                                        <form action="{{ route('admin.ic-error-handling.destroy', [$d->id, 'type' => request()->type]) }}" method="post" onsubmit="return confirm('Are you sure..?')"> @csrf @method('DELETE')
                                            <div class="btn-group">
                                                ...
                                                <a href="#" target="_blank" data-bs-toggle="modal" data-bs-target="#exampleModal" data="{{ $d->ic_error }}" custom_msg="{{ $d->custom_error }}" status="{{ $d->status }}" class="btn btn-sm btn-warning view"><i class="fa fa-eye"></i></a>
