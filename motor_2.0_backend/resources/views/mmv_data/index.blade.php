@extends('layout.app', ['activePage' => 'mmv-data', 'titlePage' => __('MMV Data')])
@section('content')
<div class="content-wrapper">
    <div class="row">
        <div class="col-lg-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title">MMV Data
                        @can('mmv_data.edit')
                        <a href="{{route('admin.sync_mmv')}}" class="btn btn-primary btn-sm float-end">Update MMV</a>
                        @endcan
                    </h5>
                    @if (session('status'))
                    ...
                    <form id="downloadForm" action="{{ url()->current() }}" method="get">
                        <div class="form-group">
                            ...
                            <br>   
                            <select name="file_name" id="" class="selectpicker" data-live-search="true" data-style="btn btn-primary btn-sm">
                            ...
                            <button type="submit" class="btn btn-primary btn-sm" onclick="downloadFile()"><i class="fa fa-download"></i> Download</button>
