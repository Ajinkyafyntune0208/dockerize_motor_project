@extends('layout.app', ['activePage' => 'user', 'titlePage' => __('Gender')])
@section('content')
            ...
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title">Gender
                        <a href="#" class="view btn btn-primary float-end btn-sm" target="_blank" data-bs-toggle="modal" data-bs-target="#rtoModal" data="">Insert New Gender</a>
                    </h5>
                    @if (session('status'))
                        ...
                        <table class="table table-striped" id="response_log">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                    <form action="{{ route('admin.gender.destroy', $data->id) }}" method="post" onsubmit="return confirm('Are you sure..?')"> @csrf @method('DELETE')
                                        <div class="btn-group">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel"> Edit Gender <span></span></h5>
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <form action="{{ route('admin.gender.update', [1, 'data' => request()->all()]) }}" method="post">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                ...
                                <div class="col-4 col-sm-4 col-md-4 col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="gender_code" id="gender_code" required/>
                                    </div>
                                </div>
                                <div class="col-4 col-sm-4 col-md-4 col-lg-4">
                                    <div class="form-group">
                                        <label for="company_alias">Company Alias</label>
                                        <input type="text" class="form-control" name="company_alias" id="company_alias" required disabled/>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
...
<div class="modal fade" id="rtoModal" tabindex="-1" aria-labelledby="rtoModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="rtoModalLabel"> Insert New Gender <span></span></h5>
                <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
                ...
                <form action="{{ route('admin.gender.store')}}" method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="col-4 col-sm-4 col-md-4 col-lg-4">
                            <div class="form-group">
                                <label for="gender">Gender</label>
                                <select class="form-control" name="gender" id="gender" style="background-color: white;color: #404040;" required>
                        ...
                        <div class="col-4 col-sm-4 col-md-4 col-lg-4">
                            <div class="form-group">
                                <label for="gender_code">Gender Code</label>
                                <select class="form-control" name="gender_code" id="gender_code" style="background-color: white;color: #404040;" required>
...
<script>
    ...
    $(document).on('click', '.view', function () {
        ...
        $('#exampleModalLabel').html(`Edit ${data.company_alias} Gender Details:`);
        $("#gender").val(data.gender);
        $("#gender_code").val(data.gender_code);
        $("#company_alias").val(data.company_alias);
        $('#id').val(data.id );

        // update button dynamic name
        $('#update-rto-btn').html(`Update ${data.company_alias} Gender`);
