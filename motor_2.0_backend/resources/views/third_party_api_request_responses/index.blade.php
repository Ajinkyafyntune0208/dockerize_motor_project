@extends('layout.app', ['activePage' => 'third_party_api_request_responses', 'titlePage' => __('Third Party Request Response Log')])
@section('content')
<!-- partial -->
<div class="content-wrapper">
    <div class="row">
        <div class="col-sm-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title">Third Party Request Response Log</h5></br>
                    @if (session('status'))
                    ...
                    <form action="">
                        <div class="row">
                            <div class="col-sm-3">
                                ...
                                <select name="name" id="name" data-style="btn-sm btn-primary" data-actions-box="true" class="selectpicker w-100" data-live-search="true"  onChange=nameChange(event) required>
                                    <option value=""></option>
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="text" name="url" class="form-control" placeholder="URL" autocomplete="off" required>
                            </div>
                            <div class="col-md-3">
