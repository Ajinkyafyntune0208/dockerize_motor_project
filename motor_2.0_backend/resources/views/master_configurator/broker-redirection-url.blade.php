            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <form action="{{route('admin.config-onboarding.broker-url-redirection')}}" method="POST" id="mybrokerform" class="form-submit">
                        ...
                        <div class="logo_url card shadow mb-3" style="background:#F4F5F7;">
                            <div class="p-2">
                        ...
                        <div class="success_payment_url_redirection card shadow mb-3" style="background:#F4F5F7;">
                            <div class="p-2">
                        ...
                        <div class="other_failure_url card shadow mb-3" style="background:#F4F5F7;">
                            <div class="p-2">
