...
<div class="container-fluid">
  <div class="row">
    <div class="col sidebar mb-3">
      <h1><i class="fa fa-calendar" aria-hidden="true"></i> {{ Config('app.name') }} Log Viewer</h1>
...
<script type="text/javascript" src="{{ asset('admin1/js/dataTables.bootstrap4.min.js') }}"></script>
