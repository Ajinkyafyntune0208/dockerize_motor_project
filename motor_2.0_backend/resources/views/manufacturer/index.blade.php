@extends('layout.app', ['activePage' => 'manufacturer', 'titlePage' => __('Manufacturer')])
@section('content')
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <ul class="nav nav-pills nav-justified" id="myTab" role="tablist">
                        ...
                        <!-- <li class="nav-item" role="presentation">
                            <a class="nav-link" id="profile-tab"  href="#tractor_manufacturer" role="tab" aria-controls="tractor_manufacturer" aria-selected="false">Bike USP</a>
                        </li> -->
                        <li class="nav-item" role="presentation">
                                ...
                                <table class="table table-striped table-bordered" id="mmv_table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td scope="col"><img src="{{$row->image_url}}" class="img-fluid" loading="lazy">
                                            </td>
                                            @foreach($row as $key => $dd)
                                            @php
                                                if( $key =='image_url'){
