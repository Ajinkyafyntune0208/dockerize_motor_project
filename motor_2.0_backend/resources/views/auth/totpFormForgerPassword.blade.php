                    ...
                    <div class="col-lg-4 mx-auto">
                        <div class="auth-form-light text-left py-5 px-4 px-sm-5">
                            ...
                            <form action="" class="pt-3" method="POST">@csrf
                                ...
                                <!-- <div class="mt-3">
                                    <button class="btn btn-block btn-primary btn-sm font-weight-medium auth-form-btn"
                                        href="#">Verify</button>
                                
                                    <a class="btn btn-block btn-secondary btn-sm font-weight-medium auth-form-btn"
