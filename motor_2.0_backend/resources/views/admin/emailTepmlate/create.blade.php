...
<main class="container-fluid">
    <div class="card">
        ...
        <div class="card-body">
            ...
            @endif
            <form action="{{ route('admin.email-sms-template.store') }}" method="post">@csrf
                <div class="form-group">
                    <label for="">Email SMS Name</label>
                    <input type="text" name="email_sms_name" class="form-control @error('email_sms_name') is-invalid @enderror" placeholder="Email SMS Name" value="{{ old('email_sms_name') }}">
                ...
                <div class="form-group">
                    ...
                    <textarea id="editor" name="body" class="form-control @error('body') is-invalid @enderror" placeholder="Body">{{ old('body') }}</textarea>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="variable" class="form-control @error('variable') is-invalid @enderror" placeholder="Variable" data-role="tagsinput" value="{{ old('variable') }}">
