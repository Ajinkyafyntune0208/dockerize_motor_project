@extends('layout.app', ['activePage' => 'payment-gateway-global-configuration', 'titlePage' => __('Payment Gateway GLobal Configuration')])
@section('content')
<style>
    .nav-link.active {
                                ...
                                <div class="tab-pane fade active show" id="nav-setting" role="tabpanel" aria-labelledby="nav-setting-tab">
                                    <form action="" method="post">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-6 col-lg-3 col-xl-2">
                                                <label for="">Select the Insurance Company : </label>
                                            </div>
                                            <div class="form-group col-12 col-md-6 col-lg-4 col-xl-3">
                                                <select required id="insuranceCompany" name="insuranceCompany" data-style="btn-sm btn-primary" data-actions-box="true" class="selectpicker w-100" data-live-search="true" name="configType">
                                                    <option value="" selected disabled>Please select</option>
                                                    @foreach ($ics as $ic)
...
<script src="{{asset('admin1/js/payment-gateway-config/ic-wise-config.js')}}"></script>
@endsection
