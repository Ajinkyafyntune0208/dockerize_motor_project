...
<main class="container-fluid">
    <div class="card">
        ...
        <div class="card-body">
            ...
            @endif
            <form action="{{ route('admin.usp.store', [ 'usp_type' => request()->usp_type ]) }}" method="post">@csrf
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="usp_desc" class="form-control @error('usp_desc') is-invalid @enderror" placeholder="USP Desc" value="{{ old('usp_desc') }}">
