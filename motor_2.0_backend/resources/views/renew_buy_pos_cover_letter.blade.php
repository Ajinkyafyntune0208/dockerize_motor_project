            ...
            <tr>
                <td>
                    <p style="font-size: 12px; line-height: 27px;">
                        ...
                        Thank you for choosing RenewBuy’s POSP advisor {{ $cover_data['posp_name'] }} with PAN {{ "XXXXXX" . \Illuminate\Support\Str::substr($cover_data['posp_pan'], -4) }} as your trusted insurance expert. Be assured that we will do our best to provide you seamless service.<br>
                        RenewBuy’s expert POSP advisor uses our SMART technology to offer the following benefits:<br>
                    </p>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td>
                    <p style="font-size: 12px; line-height: 27px;">
                        ...
                        India. <br>
                        For any kind of insurance requirement/assistance in future, feel free to get in touch with your POSP advisor ( <b> {{ $cover_data['posp_name'] }} </b> & <b>{{ $cover_data['posp_mobile'] }} </b> ).
                    </p>
                </td>
            </tr>
            <tr>
