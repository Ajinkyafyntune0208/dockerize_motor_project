                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.user.store') }}" method="POST">@csrf
                        ...
                        <div class="form-group row" style="display: flex; flex-direction: row; align-items: center;">
                            ...
                            <div class="col-sm-10">
                                <input type="email" name="email" class="form-control" id="email" value="{{ old('email') }}" placeholder="Email" autocomplete="off" required>
                                @error('email')<span class="text-danger">{{ $message }}</span>@enderror
                            </div>
                        </div>
                        <div class="form-group row"  style="display: flex; flex-direction: row; align-items: center;">
                            <label for="password" class="col-sm-2 col-form-label required">Password<br></label>
                            <div class="col-sm-10">
                                <input type="password" onselectstart="return false" onpaste="return false;" onCopy="return false" onCut="return false" onDrag="return false" onDrop="return false" name="password" onkeyup="checkFuntion()" class="form-control" id="password" placeholder="Password" required>
                                 <i class="fa fa-eye-slash" id="togglePassword" style="display: flex; align-items: center; position:absolute;  height: 82%; position:relative; left:calc(100% - 30px); bottom: 25px;"></i>
                        ...
                        <div class="form-group row" style="display: flex; flex-direction: row; align-items: center;">
                            <label for="password_confirmation" class="col-sm-2 col-form-label required">Confirm Password</label>
                            <div class="col-sm-10">
                                <input type="password" onselectstart="return false" onpaste="return false;" onCopy="return false" onCut="return false" onDrag="return false" onDrop="return false" name="password_confirmation" class="form-control" id="password_confirmation" placeholder="Confirm Password" required>
                            </div>
                        </div>
                        <div class="form-group row" style="display: flex; flex-direction: row; align-items: center;">
                        ...
                        <div class="form-group row" style="display: flex; flex-direction: row; align-items: center;">
                            ...
                            <div class="col-sm-10">
                                <div class="form-check form-switch">
                                    <input class="form-check-input" style="margin-left:0px" type="checkbox" role="switch" id="askOtp"  name= "askOtp" checked>
                                  </div>
