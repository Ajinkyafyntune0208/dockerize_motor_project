    ...
    <div class="content-wrapper">
        <div class="row">
            <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">{{ 'Configuration of ' . $v_type }}</h5>
                        @if (session('status'))
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <select name="intergration" id="intergration" class="form-select form-select-sm" aria-label=".form-select-sm example" onchange="hidePriority()">
                                            <option
                                ...
                                <div class="col-sm-6" id="prio_service1">
                                    <div class="form-group">
                                        ...
                                        @foreach ($vahan_Services as $key => $vahan_Service)
                                            <select id="services" name={{ 'service_' . $vahan_Service->id }} class="form-select form-select-sm" aria-label=".form-select-sm example">
                                ...
                                {{-- <div class="col-sm-6" id="single_service"> --}}
                                    <div class="form-group" id="single_service">
                                        <label>Services</label>
                                            <select id="single_service" name="single_service" class="form-select form-select-sm" aria-label=".form-select-sm example">
                                                @foreach ($vahan_Services as $key => $vahan_Service)
                                    ...
                                    <div class="form-group">
                                        ...
                                        @foreach ($collection as $key => $vahan_Service)
                                            <select id={{ 'select_' . $vahan_Service['id'] }}
                                                name={{ 'prio_no_' . $vahan_Service['id'] }} class="form-select form-select-sm" aria-label=".form-select-sm example">
                                                <option value=''></option>
                                    ...
                                    @foreach ($Companies as $key => $value)
                                        <div class="input-group mb-3">
                                            <div class="input-group-text div_pos_">
                                                ...
                                                <input class="form-check-input mt-0 abc"
