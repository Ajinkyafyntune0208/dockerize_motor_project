                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ route('admin.template.update', $template) }}" method="POST">@csrf @method('PUT')
                                ...
                                <div class="col-sm-10">
                                    <div class="dropdown input-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="Alias" aria-label="alias"
                                            id="alias" name="alias" readonly value="{{ $template->alias }}">
                            ...
                            <div class="form-group row" style="display: flex; flex-direction: row; align-items: center;">
                                <label for="alias" class="col-sm-2 col-form-label required">Communication
                                    Type</label>
                                <div class="col-sm-10">
                                    <input type="text" name="communication_type_email" class="form-control"
                                        id="communication_email" readonly>
                                    <select name="communication_type" data-style="btn-sm btn-primary"
                                        data-actions-box="true" class="selectpicker w-100 communication_type_hide"
                                        data-live-search="true" id="communication_type">
                            ...
                            <div class="form-group row" style="display: flex; flex-direction: row; align-items: center;"
                                ...
                                <div class="col-sm-10">
                                    {{-- <input type="text" name="footer" class="form-control" id="footer"
                                        placeholder="Global Footer" value="{{ $template->footer }}"> --}}
                                ...
                                <div class="form-group row"
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="cc" class="form-control" id="cc"
                                            placeholder="Cc" value="{{ old('cc', $template->cc) }}">
                                    </div>
                                </div>
                                <div class="form-group row"
                                    style="display: flex; flex-direction: row; align-items: center;">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="bcc" class="form-control" id="bcc"
                                            placeholder="Bcc" value="{{ old('bcc', $template->bcc) }}">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group row" style="display: flex; flex-direction: row; align-items: center;">
