@extends('layout.app', ['activePage' => 'user', 'titlePage' => __('Financier Agreement')])
@section('content')
...
<div class="content-wrapper">
    <div class="row">
        <div class="col-sm-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title">Financier Agreement
                        <a href="#" class="view btn btn-primary float-end btn-sm" target="_blank" data-bs-toggle="modal" data-bs-target="#rtoModal" data="">Insert New Financier Agreement</a>
                    </h5>
                    @if (session('status'))
                        ...
                        <table class="table table-striped" id="response_log">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                    <form action="{{ route('admin.financier-agreement-type.destroy', $data->id) }}" method="post" onsubmit="return confirm('Are you sure..?')"> @csrf @method('DELETE')
                                        <div class="btn-group">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel"> Edit Financier Agreement <span></span></h5>
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <form action="{{ route('admin.financier-agreement-type.update', [1, 'data' => request()->all()]) }}" method="post">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                ...
                                <div class="col-4 col-sm-4 col-md-4 col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="company_alias" id="company_alias" disabled required/>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
...
<div class="modal fade" id="rtoModal" tabindex="-1" aria-labelledby="rtoModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="rtoModalLabel"> Inssert New Financier Agreement <span></span></h5>
                <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form action="{{ route('admin.financier-agreement-type.store')}}" method="post">
                    @csrf
                    @method('POST')
                    <div class="row">
                        <input type="text" name="id" id="id"  hidden/>
...
<script>
    ...
    $(document).on('click', '.view', function () {
        ...
        $('#exampleModalLabel').html(`Edit ${data.company_alias} Financier Agreement Details:`);
        $("#code").val(data.code);
        $("#name").val(data.name);
        ...
        $('#update-rto-btn').html(`Update ${data.company_alias} Financier Agreement`);
