...
<body>
    ...
    <div class="container-scroller">
        @include('vahan_service_layout.nav.auth')
        <!-- partial -->
        <div class="container-fluid page-body-wrapper">
            @include('vahan_service_layout.sidebar')
            <!-- partial -->
            <div class="main-panel">
                @yield('content')
                @include('vahan_service_layout.footer.auth')
            </div>
            <!-- main-panel ends -->
        </div>
    ...
    <script src="{{ asset('admin1/js/bootstrap-multiselect.min.js') }}"></script>
    <script src="{{ asset('admin1/js/bootstrap4-toggle.min.js') }}"></script>
