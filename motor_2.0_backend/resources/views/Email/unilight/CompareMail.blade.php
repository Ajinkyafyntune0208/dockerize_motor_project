                            ...
                            <tr>
                                <td style="text-align:left;padding:10px 0px 12px 30px" valign="bottom" width="100%"><a
                                        ...
                                        style="text-decoration:none;outline:none"><img
                                            ...
                                            title="{{-- ComparePolicy.com --}}{{ config('app.ame') }}" width="160"/> </a></td>
                            </tr>
                            </tbody>
                        </table>
                    </td>
                                                        ...
                                                        <td align="left" colspan="2"
                                                            ...
                                                            <div style="margin: 20px 40px; letter-spacing: 0.3px;">
                                                                <p style="font: bold 18px Calibri,Candara,Arial;color: #da154c;margin-bottom: 10px;padding: 0px;">Dear {{ $mailData['name'] }}</p>
                                                                    ...
                                                                    <p style="margin-top: 2rem;margin-bottom: 1.5rem;font-size: 0.9rem;font-weight: bold;">Please find attached comparision of {{ $mailData['productName'] }} Insurance based on following details.</p>
