																			...
																			<tr>
																				<td align="left" colspan="2" style="background:#ffffff;font:normal 15px 'Lato','Helvetica Neue',Helvetica,Tahoma,Arial,sans-serif;color:#314451;text-align:left;color:#314452;line-height:1.3em;padding:20px" valign="top">
																					<div style="margin: 20px 40px; letter-spacing: 0.3px;">
																						...
																						<div style="padding: 10px 5px;letter-spacing: 0;font-size: 0.8rem;color: #222222;font-family: sans-serif;">Thank you for visiting {{ config('app.name') }} for your {{ $mailData['section'] }} needs. As per the details shared by you please find below multiple quotes from different insurers. </div>
																						<div style="padding: 10px 5px;letter-spacing: 0;font-size: 0.9rem;color: #222222;font-family: sans-serif;">Quotes Prepared for you </div>
																							...
																							<tbody>
																								...
																								<tr style="background: #f0fafe;color: #012870;">
																									...
																									<td style="text-align: center;">
																										<a href="{{ $quote['action'] }}" style="background: #0000ffb0;color: #fff;border: none;border-radius: 4px;padding: 8px; text-decoration: none">Proceed</a>
																									</td>
																								</tr>
																								@endforeach
																							</tbody>
