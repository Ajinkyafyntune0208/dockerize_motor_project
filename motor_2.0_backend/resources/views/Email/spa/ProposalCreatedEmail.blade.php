																				...
																				<td align="left" colspan="2" style="background:#ffffff;font:normal 15px 'Lato','Helvetica Neue',Helvetica,Tahoma,Arial,sans-serif;color:#314451;text-align:left;color:#314452;line-height:1.3em;padding:20px" valign="top">
																					<div style="margin: 40px 40px;">
																						...
																						<div style="padding: 0px 10px;">
																							<p style="margin-top: 2.5rem;margin-bottom: 1.5rem;font-size: 0.9rem;font-weight: bold;">Please <a href="{{$mailData['link']}}">Click here</a> to pay the premium for your motor insurance policy of vehicle {{$mailData['vehicale_registration_number']}}. Proposal No. {{$mailData['proposal_no']}}.</p>
																							<p style="margin-top: 2.5rem;margin-bottom: 1.5rem;font-size: 0.9rem;font-weight: bold;">Your Total Payable Amount is Rs. {{ $mailData['final_amount'] }}. Kindly note that this link will be valid only till {{ now()->endOfDay() }}. </p>
