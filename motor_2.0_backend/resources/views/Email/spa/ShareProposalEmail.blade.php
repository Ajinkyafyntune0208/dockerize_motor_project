																				...
																				<td align="left" colspan="2" style="background:#ffffff;font:normal 15px 'Lato','Helvetica Neue',Helvetica,Tahoma,Arial,sans-serif;color:#314451;text-align:left;color:#314452;line-height:1.3em;padding:20px" valign="top">
																					<div style="margin: 40px 40px;">
																						...
																						<div style="padding: 0px 10px;">
																							<p style="margin-top: 2.5rem;margin-bottom: 1.5rem;font-size: 0.9rem;font-weight: bold;">You are just few steps away from securing your vehicle. To view your proposal and complete the purchase of your {{$mailData['product_name']}},</p>
																							<p style="font-size: 0.85rem;">
																								<a href="{{ $mailData['link'] }}">Click Here</a>
																							</p>
