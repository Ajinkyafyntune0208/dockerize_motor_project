                                                                                ...
                                                                                <td align="left" colspan="2" style="background:#ffffff;font:normal 15px 'Lato','Helvetica Neue',Helvetica,Tahoma,Arial,sans-serif;color:#314451;text-align:left;color:#314452;line-height:1.3em;padding:20px" valign="top">
                                                                                    <div style="margin: 20px 40px; letter-spacing: 0.3px;">
                                                                                        ...
                                                                                        <div style="padding: 0px 10px;">
                                                                                            <p style="margin-top: 2rem;margin-bottom: 1.5rem;font-size: 0.9rem;font-weight: bold;">Thank you for visiting {{config('app.name')}} for your {{ $mailData['productName'] }} needs. Now you can compare and buy the best motor insurance from leading insurers. You have shared the following vehicle details with us :</p>
                                                                                            ...
                                                                                            <p style="margin-top: 50px;font-size: 0.85rem;font-weight: bold;">As per the above details, please find below the feature comparison table of the plans that you have selected. You can choose the best plan that suits you. These quotes are valid only till midnight today.</p>
                                                                                            ...
                                                                                            <p style="margin-top: 30px;font-size: 0.85rem;font-weight: bold;letter-spacing: 0.3px;">For any further assistance, please call us on {{ config('constants.brokerConstant.tollfree_number')}} or write to us at <a href="mailto:{{ config('constants.brokerConstant.support_email') }}">{{ config('constants.brokerConstant.support_email') }}</a></p>
