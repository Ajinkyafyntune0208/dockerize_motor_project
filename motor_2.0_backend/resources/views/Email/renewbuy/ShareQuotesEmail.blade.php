																				...
																				<td align="left" colspan="2" style="background:#ffffff;font:normal 15px 'Lato','Helvetica Neue',Helvetica,Tahoma,Arial,sans-serif;color:#314451;text-align:left;color:#314452;line-height:1.3em;padding:20px" valign="top">
																					<div style="margin: 20px 40px; letter-spacing: 0.3px;">
																						...
																						<table style="width: 100%;">
																							<thead style="background: #0066af;color: #fff;font-size: 1rem;">
																								<tr>
																							...
																							<tbody>
																								...
																								<tr style="background: #d0e3f1;color: #000;">{{-- #f27f21 --}}
																									...
																									@endif
																									<td style="text-align: center;">{{ $quote['policyType'] ?? "" }}</td>
																									<td style="text-align: center;">
																										<a href="{{ $quote['action'] }}" style="text-decoration: none; background: #f4690c;color: #fff;border: none;border-radius: 0px;padding: 8px;">Proceed</a>
																									</td>
																								</tr>
																								@endforeach
																							</tbody>
