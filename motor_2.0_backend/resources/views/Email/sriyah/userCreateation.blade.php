                                                                                ...
                                                                                <td align="left" colspan="2"
                                                                                    ...
                                                                                    <div style="margin: 40px 40px;">
                                                                                        ...
                                                                                        <div style="padding: 0px 10px;">
                                                                                            <p
                                                                                                style="margin-top: 2.5rem;margin-bottom: 1.5rem;font-size: 0.9rem;font-weight: bold;">
                                                                                                We are happy that you
                                                                                                have visited
                                                                                                www.nammacover.com for
                                                                                                your insurance needs.
                                                                                                You can choose from a
                                                                                                range of health and car
                                                                                                insurances from the best
                                                                                                plans.</p>
                                                                                            <p
                                                                                                style="margin-top: 2.5rem;margin-bottom: 1.5rem;font-size: 0.9rem;font-weight: bold;">
                                                                                                Based on the information
                                                                                                you have provided during
                                                                                                your search, we have
                                                                                                created a login for you.
                                                                                                You can access your
                                                                                                policy searches and
                                                                                                purchased plans at <a
                                                                                                    href="https://account.nammacover.com/customer/login">https://account.nammacover.com/customer/login</a>
                                                                                            </p>
                                                                                            <p
                                                                                                style="margin-top: 2.5rem;margin-bottom: 1.5rem;font-size: 0.9rem;font-weight: bold;">
                                                                                            ...
                                                                                            <div
                                                                                                style="{{-- display: flex;flex-direction: column; --}}margin-top: 60px;">
                                                                                                <span>Best
                                                                                                    Regards,</span><br><br>
                                                                                                <strong
