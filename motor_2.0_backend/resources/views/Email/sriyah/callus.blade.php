																				...
																				<td align="left" colspan="2" style="background:#ffffff;font:normal 15px 'Lato','Helvetica Neue',Helvetica,Tahoma,Arial,sans-serif;color:#314451;text-align:left;color:#314452;line-height:1.3em;padding:20px" valign="top">
																					<div style="margin: 20px 40px; letter-spacing: 0.3px;">	
																						<div style="padding: 0px 10px;">
																						    ...
																						    <p style="font-size: 1rem">The customer below has requested your assistance,</p>

																							<p style="margin: 0;padding: 0; color: darkblue;font-size: 0.9rem;font-weight: bold;">Name: {{ $mailData['contactName'] ?? '' }}</p>
																							<p style="margin: 0;padding: 0; color: darkblue;font-size: 0.9rem;font-weight: bold;">Ph No: {{ $mailData['contactNo'] ?? '' }}</p>
																							<p style="margin: 0;padding: 0; color: darkblue;font-size: 0.9rem;font-weight: bold;">Email: {{ $mailData['email'] ?? '' }}</p>
																							<p style="margin-top: 30px;font-size: 1rem">Please call back and respond at the earliest to assist and delight the customer.</p>
																							<div style="margin-top: 30px;">
																								<span>Best regards,</span> <br>
																								<br>
																								<strong style="color: darkblue;">{{ config('app.name') }} portal</strong>
																							</div>
																						</div>
																				</td>
																			</tr>
