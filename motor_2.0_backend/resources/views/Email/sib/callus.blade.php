                                            ...
                                            <tr>
                                                <td style="text-align:left;padding:10px 0px 12px 30px" valign="bottom"
                                                    ...
                                                    <a href="{{ config('email_logo_redirection_url') }}"
                                                        ...
                                                        <img src="{{ $mailData['logo'] ?? '' }}"
                                                            title="{{ config('app.ame') }}" width="160" />
                                                    </a>
                                                </td>
                                            </tr>
                                        </tbody>
                                                                                ...
                                                                                <td align="left" colspan="2"
                                                                                    ...
                                                                                    <div
                                                                                        ...
                                                                                        <div style="padding: 0px 10px;">
                                                                                            ...
                                                                                            <p
                                                                                                style="margin-top: 30px;font-size: 1rem">
                                                                                                Please call back and
                                                                                                respond at the earliest
                                                                                                to assist and delight
                                                                                                the customer.</p>
                                                                                            <div
