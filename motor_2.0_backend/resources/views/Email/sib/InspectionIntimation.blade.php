                                                                                ...
                                                                                <td align="left" colspan="2"
                                                                                    ...
                                                                                    <div
                                                                                        ...
                                                                                        <p
                                                                                            ...
                                                                                            Dear {{ trim($mailData['name']) }},
                                                                                        </p>
                                                                                        
                                                                                        <p style="margin-top: 2rem;margin-bottom: 1.5rem;font-size: 0.9rem;">
                                                                                            Your Inspection request with
                                                                                            <b>{{ $mailData['insurer'] }}</b> for
                                                                                            vehicle
                                                                                            <b>{{ $mailData['registration_number'] }}</b>
                                                                                            is raised with ID/Reference ID
                                                                                            <b>{{ $mailData['reference_id'] }}</b>
                                                                                            on
                                                                                            <b>{{ $mailData['time_stamp'] }}</b>.
                                                                                        </p>
