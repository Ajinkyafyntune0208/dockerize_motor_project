                                                                            ...
                                                                            <tr>
                                                                                <td align="left" colspan="2"
                                                                                    ...
                                                                                    <div
                                                                                        ...
                                                                                        <p
                                                                                            style="margin-top: 2rem;margin-bottom: 1.5rem;font-size: 0.9rem;">
                                                                                            Your Inspection request with
                                                                                            <b>{{ $mailData['insurer'] }}</b>
                                                                                            for vehicle reg no. <b>{{ $mailData['registration_number'] }}</b> is
                                                                                            approved. Kindly click on
                                                                                            the <a href="{{ $mailData['payment_url'] }}">payment link </a>
                                                                                            for the payment of Rs.
                                                                                            <b>{{ $mailData['payment_amount'] }}.</b>
                                                                                        </p>

                                                                                        <p
                                                                                            style="margin-top: 30px;font-size: 0.9rem;font-weight: bold;letter-spacing: 0.3px;">
                                                                                        ...
                                                                                        <div style="margin-top: 20px;">
                                                                                            <strong class="mt-5"
                                                                                                style="color: darkblue;">{{ config('app.name') }}</strong>
                                                                                        </div>
                                                                                </td>
                                                                            </tr>
                                                                            <tr>
