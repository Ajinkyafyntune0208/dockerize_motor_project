                                                                ...
                                                                <td align="center"
                                                                    ...
                                                                    <table align="left" border="0" cellpadding="0"
                                                                        ...
                                                                        <tbody>
                                                                            <tr>
                                                                                <td align="left" colspan="2"
                                                                                    ...
                                                                                    <div style="margin: 20px 40px;" class="margin-class">
                                                                                        <p style="font: bold 1.1rem Calibri,Candara,Arial;color:#075672;margin-bottom: 10px;padding: 0px;">
                                                                                            Dear {{ trim($mailData['name']) }},</p>
                                                                                        @yield('content')

                                                                                        <p style="margin-top:30px;font-size: 0.9rem;font-weight:bold;">For any assistance,
                                                                                        ...
                                                                                        <div style="margin-top: 30px;">
                                                                                            ...
                                                                                            <p style="font-size: 0.9rem;color:#075672">
                                                                            ...
                                                                            <tr>
                                                                                <td
                                                                                    style="background:#71b5cd; font-size:11px; color:#fff; text-align:center;">
                                                                                    <div
