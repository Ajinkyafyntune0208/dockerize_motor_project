...
class InsertUnitedIndiaWithoutNcbDiscountGridCv extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::dropIfExists('united_india_without_ncb_discount_grid_cv');
        Schema::create('united_india_without_ncb_discount_grid_cv', function (Blueprint $table) {
        ...
        Artisan::call('db:seed --class=united_india_without_ncb_discount_grid_cv');
