...
class CreateUnitedIndiaWithNcbUpdatedDiscountGridTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::dropIfExists('united_india_with_ncb_updated_discount_grid');
        
        Schema::create('united_india_with_ncb_updated_discount_grid', function (Blueprint $table) {
