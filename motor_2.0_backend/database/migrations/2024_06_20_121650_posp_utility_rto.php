...
class PospUtilityRto extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        if (!Schema::hasTable('posp_utility_rto')) 
        {
            Schema::create('posp_utility_rto', function (Blueprint $table) {
                $table->increments('utility_rto_id');
    ...
    {
        Schema::dropIfExists('posp_utility_rto');
    }
}
