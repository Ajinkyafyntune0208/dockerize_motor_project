...
class CreatePcvApplicableAddonsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('pcv_applicable_addons', function (Blueprint $table) {
            $table->id('addon_id');
    ...
    {
        Schema::dropIfExists('pcv_applicable_addons');
    }
}
