...
class CreateBikeApplicableAddonsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('bike_applicable_addons', function (Blueprint $table) {
            $table->id('addon_id');
    ...
    {
        Schema::dropIfExists('bike_applicable_addons');
    }
}
