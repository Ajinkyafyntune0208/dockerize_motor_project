...
class ChollaMandalamTokenGeneration
{
    public function generateToken(Request $request, $requestData){
        try{
            ...
            $data = httpRequestNormal(config('constants.IcConstants.cholla_madalam.END_POINT_URL_CHOLLA_MANDALAM_MOTOR_TOKEN'), 'POST', $token_param, [], $additionalData['headers'], [], false, []);
