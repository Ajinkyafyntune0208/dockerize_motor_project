    ...
    public function generateToken(Request $request, $requestData)
    {
        try{
            ...
            $additionalData['headers'] = [
                ...
                'Authorization' => 'Basic ' . config('constants.IcConstants.cholla_madalam.CHOLLA_MANDALAM_MOTOR_API_KEY')
            ];
            ...
            $data = httpRequestNormal(config('constants.IcConstants.cholla_madalam.END_POINT_URL_CHOLLA_MANDALAM_MOTOR_TOKEN'), 'POST', $token_param, [], $additionalData['headers'], [], false, true, []);
