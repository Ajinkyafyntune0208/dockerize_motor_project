...
class HyundaiInactiveDataProcessTest implements ShouldQueue
{
    ...
    {
        set_time_limit(0);        
        $allfiles = Storage::allFiles('hyundai_inactive_data_process');
        //dd(count($allfiles));
        if (count($allfiles) == 0)
        return;
        ...
        //                        'marital_status'                  => "Married",
            ...
            Storage::move($file, 'hyundai_inactive_data_upload/'.$move_file_name);        
            //Storage::delete($file); 
        }
