...
class HyundaiInactiveDataProcess implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        $allfiles = scandir('/mnt/hyundai_inactive_data_process');
	...
	foreach($allfiles as $file)
	{
	    ...
	    $onlyFileName = $file;
	    $file = "/mnt/hyundai_inactive_data_process/".$file;
	    $movedFileName =  "/mnt/hyundai_inactive_data_upload/".$onlyFileName;
			    ...
			    $city = $value['cityname'];
                            ...
                            { 
                                $data_status_data = [
                                    ...
                                    'company_alias'     => 'HYUNDAI INACTIVE'
                                ];
        ...
        //                        'marital_status'                  => "Married",
                            ...
                            DB::table('hyundai_inactive_migration_data_reports')->insert($data_status_data);
                        } 
                    }
                    else
                    {
