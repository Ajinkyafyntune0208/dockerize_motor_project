...
class shriramgcvpaymentgateway{
...
function  make($request)
{
    ...
    $return_data = [       
        'form_action' => config('constants.cv.shriram.SHRIRAM_XML_PAYMENT_URL_PCV'),
        ...
        'form_data' => [
            ...
            'createdBy' => config('constants.IcConstants.shriram.SHRIRAMGCV_USERNAME'), //"NiveshIns",//config('constants.IcConstants.shriram.SHRIRAMGCV_USERNAME'),
...
static function JSONGcvConfirm($request, $user_proposal)
{
...
$response = json_decode($payment_response->response);
    ...
    {
        if(strtolower(config('constants.cv.shriram.SHRIRAM_CV_REQUEST_TYPE')) == 'json'){
