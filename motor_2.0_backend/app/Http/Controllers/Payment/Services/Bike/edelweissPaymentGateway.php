...
class edelweissPaymentGateway
{
    ...
    public static  function  create_checksum($enquiryId, $request)
    {
        ...
        $bill_desk_request =
            [
                'MerchantID'        => config('constants.IcConstants.edelweiss.BIKE_MERCHANT_ID'),
                ...
                'ItemCode'          => 'NA',
                'TypeField1'        => 'R',
                'UserID'            => config('constants.IcConstants.edelweiss.BIKE_USER_ID'),
                'Filler4'           => 'NA',
                'Filler5'           => 'NA',
                'TypeField2'        => 'F',
                'AdditionalInfo1'   => $data['proposal_no'],
                'AdditionalInfo2'   => config('constants.IcConstants.edelweiss.MOTOR_USERNAME'),
                'AdditionalInfo3'   => 'NA',
                'AdditionalInfo4'   => 'NA',
                'AdditionalInfo5'   => 'NA',
                'AdditionalInfo6'   => 'NA',
    ...
    public static function confirm($request)
    {
        ...
        if ($request_data != null && isset($_REQUEST['msg'])) {
            ...
            if ($AuthStatus == '0300') {
                ...
                $get_response = getWsData(
                    config('constants.IcConstants.edelweiss.END_POINT_URL_EDELWEISS_BIKE_POLICY_GENERATION'),
                    $request_policy_gen,
                    'edelweiss',
                    [
                        'enquiryId' => $request_data['enquiry_id'],
                ...
                if (isset($response_policy_gen['issuePolicyObject']['issuepolicy']['policynrTt'])) {
                    ...
                    $get_response = getWsData(
                        config('constants.IcConstants.edelweiss.END_POINT_URL_EDELWEISS_BIKE_PAYMENT_REQUEST'),
                        $payment_request_data,
                        'edelweiss',
                        [
                            'enquiryId' => $request_data['enquiry_id'],
                    ...
                    if ($payment_response_data) {
                        ...
                        $get_response = getWsData(
                            config('constants.IcConstants.edelweiss.END_POINT_URL_EDELWEISS_BIKE_PDF_SERVICE'),
                            $edelweiss_pdf_request,
                            'edelweiss',
                            [
                                'enquiryId' => $request_data['enquiry_id'],
