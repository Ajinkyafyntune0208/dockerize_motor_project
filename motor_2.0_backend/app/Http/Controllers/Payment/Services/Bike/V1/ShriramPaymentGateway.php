...
class ShriramPaymentGateway
{
    ...
    public static function make($request)
    {
        ...
        DB::table('payment_request_response')
            ...
            $payment_url = config('IC.SHRIRAM.V1.BIKE.PAYMENT_URL'); //constants.motor.shriram.PAYMENT_URL_JSON
            $paymentFrom = config('IC.SHRIRAM.V1.BIKE.PAYMENT_URL_PAYMENTFROM'); //constants.motor.shriram.PAYMENT_URL_JSON_PAYMENTFROM
    ...
    static public function generatePdf($request)
    {
        ...
        {
            //constants.motor.shriram.SHRIRAM_BIKE_JSON_REQUEST_TYPE
            if (strtolower(config('IC.SHRIRAM.V1.BIKE.REQUEST_TYPE')) == 'json') {
            ...
            $input_array = [
                'soap:Header' => [
                    'soap:AuthHeader' => [
                        ...
                        'Username'    => config('IC.SHRIRAM.V1.BIKE.AUTH_NAME'), //constants.motor.shriram.AUTH_NAME_SHRIRAM_MOTOR
                        'Password'    => config('IC.SHRIRAM.V1.BIKE.AUTH_PASS'), //constants.motor.shriram.AUTH_PASS_SHRIRAM_MOTOR
                    ]
                ],
                'soap:Body'   => [
                    'PolicyScheduleURL' => [
            ...
            $get_response = getWsData(
                    config('IC.SHRIRAM.V1.BIKE.POLICY_APPROVED_URL'), //constants.IcConstants.shriram.SHRIRAM_POLICY_APPROVED_URL
            ...
            //constants.motor.shriram.SHRIRAM_MOTOR_GENERATE_PDF
            $doc_link = config('IC.SHRIRAM.V1.BIKE.GENERATE_PDF').'PolSysId=' . $proposal->pol_sys_id . '&LogoYN=Y';
