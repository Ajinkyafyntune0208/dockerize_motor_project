...
class tataAigV2PaymentGateway
{
    ...
    public static function make($request)
    {
        ...
        $return_data = [
            'form_action' => $generatePaymentResponse['url'],
            'form_method' => 'post',
            'payment_type' => 0, // form-submit
            'form_data' => [
                'pgiRequest' => $generatePaymentResponse['pgiRequest']
            ]
        ];
        ...
        DB::table('payment_request_response')->insert([
            ...
            'payment_url'               => $generatePaymentResponse['url'],
    ...
    public static function generatePaymentService($enquiryId, $proposal, $masterProduct)
    {
        ...
        $paymentRequest = [
            ...
            'payer_id'              => '',
            'payer_pan_no'          => '',
            'payer_name'            => $proposal->first_name .' '. $proposal->last_name,
            'payer_relationship'    => '',
...
//        );
    ...
    static public function policyDownloadService($enquiryId, $proposal, $productData, $verifyPaymentServiceResponse, $token_response)
    {
        ...
        $pdf_url = config('constants.motorConstant.CAR_PROPOSAL_PDF_URL') . 'tata_aig_v2/'. md5($proposal->user_proposal_id).'.pdf';
    ...
    static public function generatePdf($request)
    {
        ...
        $token_response = TATA_AIG::getToken($user_product_journey_id, $productData);
        ...
        if($policy_details->pdf_url == '')
        {
            ...
            // }
                ...
                // echo "<pre>";print_r([$generatePolicy]);echo "</pre>";die();
