...
class IffcoTokioPaymentGateway 
{   
      /**
     * @param $request
    ...
    public static function make($request)
    {
        ...
        if($proposal_data){
            ...
            //constants.IcConstants.iffco_tokio.PAYMENT_GATEWAY_LINK_IFFCO_TOKIO_MOTOR
            $payment_url = config('IC.IFFCO_TOKIO.V1.CAR.PAYMENT_GATEWAY_LINK');
            $partnerType = '';
            $pospPanNumber = '';
            ...
            $Policy = [                     
                ...
                'ExternalBranch' => Config('IC.IFFCO_TOKIO.V1.CAR.PARTNER_BRANCH_CAR'), //constants.IcConstants.iffco_tokio.partnerBranchCar
                'ExternalServiceConsumer' => Config('IC.IFFCO_TOKIO.V1.CAR.PARTNER_CODE_CAR'), //constants.IcConstants.iffco_tokio.partnerCodeCar
                'ExternalSubBranch' => Config('IC.IFFCO_TOKIO.V1.CAR.PARTNER_SUB_BRANCH_CAR'), // constants.IcConstants.iffco_tokio.partnerSubBranchCar
                'GeneralPage' => '', 
                ...
                'Product' => Config('IC.IFFCO_TOKIO.V1.CAR.CONTRACT_TYPE_CAR'), //constants.IcConstants.iffco_tokio.contractType_Car
            ...
            $Vehicle = [
                ...
                'VehicleBody' => '',           
                'Zcover' => ( $premium_type != "third_party"  && $premium_type != 'third_party_breakin' )  ? Config('IC.IFFCO_TOKIO.V1.CAR.ZCOVER_BIKE_CO') : Config('IC.IFFCO_TOKIO.V1.CAR.ZCOVER_BIKE_TP'), //constants.IcConstants.iffco_tokio.zcover_car_co // constants.IcConstants.iffco_tokio.zcover_car_tp
            ...
            $return_data = [
                ...
                'form_data' => [
                    ...
                    'PARTNER_CODE' => Config('IC.IFFCO_TOKIO.V1.CAR.PARTNER_CODE_CAR'), //constants.IcConstants.iffco_tokio.partnerCodeCar
    ...
    public static function generate_pdf($user_proposal, $is_rehit = 'N') {
        ...
        $get_response = getWsData(
            config('IC.IFFCO_TOKIO.V1.CAR.END_POINT_URL_PDF'), //constants.IcConstants.iffco_tokio.END_POINT_URL_IFFCO_TOKIO_MOTOR_PDF
            $request_array,
            'iffco_tokio',
            [
                'requestMethod' =>'post',
                ...
                'enquiryId' => $user_proposal->user_product_journey_id,
                'transaction_type' => 'proposal',
                'username' => config('IC.IFFCO_TOKIO.V1.CAR.PARTNER_CODE_CAR'), //constants.IcConstants.iffco_tokio.partnerCodeCar
                'password' => config('IC.IFFCO_TOKIO.V1.CAR.AUTH_PASSWORD_CAR') //constants.IcConstants.iffco_tokio.AUTH_PASSWORD_CAR
            ]
        );
    ...
    public static function updatePaymentStatus($user_product_journey_id) {
        ...
        foreach($payment_records as $k => $row) {
            ...
            $get_response = getWsData(config('IC.IFFCO_TOKIO.V1.CAR.ENDPOINT_PAYMENT_STATUS_CHECK'), //constants.IcConstants.iffco_tokio.ENDPOINT_PAYMENT_STATUS_CHECK
                $payment_status_check,
                'iffco_tokio',
                [
