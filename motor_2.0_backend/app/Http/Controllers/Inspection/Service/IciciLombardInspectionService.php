...
class IciciLombardInspectionService
{
    ...
    {
        if (config('constants.IcConstants.icici_lombard.ICICI_LOMBARD_BREAKIN_STATUS_API_CHECK_ENABLE') == 'Y') {
            ...
            if ($breakinDetails) {
                ...
                if (in_array($data['breakinStatus'],['Recommended'])) {
                    ...
                    if ((isset($inspectionFinalStatusResponse['vehicleInspectionStatus']) && $inspectionFinalStatusResponse['vehicleInspectionStatus'] == 'PASS') || ($inspectionFinalStatusResponse['message'] == 'Given Reference No is Already Precessed For Vehicle Inspection.')) {
