...
namespace App\Http\Controllers\Inspection\Service\Bike\V2;
        ...
        if($breakinDetails)
        {
            ...
            else
            {
                    ...
                    else
                    {
                        ...
                        $url = config('IC.GODIGIT.V2.BIKE.END_POINT_URL');
                        $get_response = getWsData($url,
                                ...
                                [
                                    ...
                                    'integrationId'     => config('IC.GODIGIT.V2.BIKE.CHECK_BREAKIN_INTEGRATIONID'),
               ...
               $proposal_resp_array = array_change_key_case(json_decode($data, TRUE),CASE_LOWER);
