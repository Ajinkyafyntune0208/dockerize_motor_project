...
namespace App\Http\Controllers\Inspection\Service\Car\V2;
        ...
        if($breakinDetails)
        {
            ...
            else
            {
                    ...
                    else
                    {
                        ...
                        $url = config('IC.GODIGIT.V2.CAR.END_POINT_URL');
                        $get_response = getWsData($url,
                                ...
                                [
                                    ...
                                    'integrationId'     => config('IC.GODIGIT.V2.CAR.CHECK_BREAKIN_INTEGRATIONID'),
