...
//        // COVERS
        ...
        $product_id = ($is_package ? config('constants.IcConstants.cholla_madalam.CHOLLA_MANDALAM_BIKE_PRODUCT_ID') : ($is_liability ? config('constants.IcConstants.cholla_madalam.CHOLLA_MANDALAM_BIKE_PRODUCT_ID_TP') : config('constants.IcConstants.cholla_madalam.CHOLLA_MANDALAM_BIKE_PRODUCT_ID_OD')));
...
//print_r($token);
        ...
        $quote_array = [
            ...
            'IMDShortcode_Dev' => config('constants.IcConstants.cholla_madalam.CHOLLA_MANDALAM_BIKE_IMDSHORTCODE_DEV'),
            'product_id' => $product_id,
            'user_code' => config('constants.IcConstants.cholla_madalam.CHOLLA_MANDALAM_BIKE_USER_CODE'),
...
//            'unnamed_passenger_cover_optional'      => ($is_pa_unnamed ? 'Yes' : 'No'),
        ...
        {
            $quote_array['IMDShortcode_Dev'] = config('constants.IcConstants.cholla_madalam.CHOLLA_MANDALAM_BIKE_TP_IMDSHORTCODE_DEV');
        }
        ...
        $quote_url = ($is_package ? config('constants.IcConstants.cholla_madalam.END_POINT_URL_CHOLLA_MANDALAM_BIKE_QUOTE') : ($is_liability ? config('constants.IcConstants.cholla_madalam.END_POINT_URL_CHOLLA_MANDALAM_BIKE_QUOTE_TP') : config('constants.IcConstants.cholla_madalam.END_POINT_URL_CHOLLA_MANDALAM_BIKE_QUOTE_OD')));
...
//                $quote_array                                    = $premium_request;
                ...
                $get_response = getWsData(
                    config('constants.IcConstants.cholla_madalam.END_POINT_URL_CHOLLA_MANDALAM_BIKE_PROPOSAL'),
                    $quote_array,
                    'cholla_mandalam',
                    $additional_data_proposal
