...
use DateInterval;
use DateTime;
use App\Http\Controllers\Proposal\Services\universalSompoSubmitProposalMiscd;
use App\Http\Controllers\SyncPremiumDetail\Services\UniversalSompoPremiumDetailController;
use App\Http\Controllers\Proposal\Services\V2\MISCD\universalSompoSubmitProposalMiscd as MISCDV2;
...
class universalSompoSubmitProposal
{
    ...
    {   
        ...
        if($is_MISC == 3 && config('IC.UNIVERSAL_SOMPO.V2.MISCD.ENABLED') == 'Y'){
            return MISCDV2::submit($proposal, $request, $step);
        }elseif ($is_MISC == 3){
            return universalSompoSubmitProposalMiscd::submit($proposal, $request);
        }
     ...
     /*$mmv = [
            ...
            [
                ...
                'VEHICLEMODELCODE' => '64833',
                'VEHICLEMODEL' => '215 DI',
                'NUMBEROFWHEELS' => '4',
                'CUBICCAPACITY' => '2730',
                'GROSSVEHICLEWEIGHT' => '780',
                'SEATINGCAPACITY' => '1',
                'CARRYINGCAPACITY' => '1',
                'BODYTYPECODE'=>'30',
                'VEHICLEMODELSTATUS' => 'Active',
                'TXT_OBSOLETE_FLAG' => '0',
                'NUM_VEHICLE_SUBCLASS_CODE' => '9',
                        ...
                        'PreviousPolDtlGroupData' => [
                            ...
                            'PolicyEffectiveFrom' => [
                                ...
                                '@attributes' => [
                                    ...
                                    'Value' => ($requestData->business_type == 'newbusiness' ? '' : ($premium_type == 'own_damage' ? date('d/m/Y', strtotime($additional_data['prepolicy']['tpStartDate'])) : $previous_policy_start_date))
                                ],
                            ],
                            'DateOfInspection' => [
                                '@value' => '',
