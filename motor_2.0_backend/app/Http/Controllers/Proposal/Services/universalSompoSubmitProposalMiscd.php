...
include_once app_path() . '/Quotes/Cv/universal_sompo.php';
...
class universalSompoSubmitProposalMiscd
{
    ...
    public static function submit($proposal, $request, $step='')
    {
        ...
        //         //ic master labels
        //         'VEHICLECLASSCODE' => '35',
        //         'MANUFACTURER' => 'C70 ROAD ROLLER C70 ROAD ROLLER',
        //         'VEHICLEMODELCODE' => '49486',
        //         'VEHICLEMODEL' => '49486',
        //         'NUMBEROFWHEELS' => '4',
        //         'CUBICCAPACITY' => '2450',
        ...
        //         'TXT_OBSOLETE_FLAG' => '0',
        //         'NUM_VEHICLE_SUBCLASS_CODE' => '48',
        //         'CNVM_FUEL_TYPE'=> 'DIESEL',
        //          //our master lables
        ...
        $vehicle_age = $age / 12;
        $vehicle_age = round($vehicle_age,2);

       
        $is_GCV = policyProductType($productData->policy_id)->parent_id == 4;
        $vehicle_make_name = strtolower($mmv_data->manufacturer);
        $usgi_applicable_addons = get_usgi_applicable_addons($vehicle_age,$vehicle_make_name,$interval, $is_GCV);
        ...
        $vehical_class_code = '24';
            ...
            if($requestData->business_type != 'newbusiness')
            {
                ...
                {
                    $insurer_name = DB::table('previous_insurer_mappping')->where('universal_sompo', $additional_data['prepolicy']['tpInsuranceCompany'])->select('previous_insurer')->first();
                    if(!$insurer_name){
                        return [
                            'status' => false,
            ...
            if ($addons) {
                ...
                if ($addons->applicable_addons) 
                {
                    ...
                    foreach ($addons->applicable_addons as $key => $addons_val) 
                    {
                        ...
                        {
                            if ($addons_val['name'] == 'Zero Depreciation' && $usgi_applicable_addons['zero_dep'] == 'True') 
                            {
                ...
                [
                    ...
                    '5' => [
                        ...
                        'Applicable' => [
                            ...
                            '@attributes' => [
                                'Name' => 'Applicable',
                                'Value' => $premium_type == 'third_party' || $vehicle_age >= 10 ? 'False' : $usgi_applicable_addons['rsa']
                            ],
                        ],
                        'AddonCoverGroups' => [
                            '@value' => '',
                        ...
                        'PreviousPolDtlGroupData' => [
                            ...
                            'PolicyEffectiveTo' => [
                                ...
                                '@attributes' => [
                                    ...
                                    'Value' => ($requestData->business_type == 'newbusiness' ? '' : ($premium_type == 'own_damage' ? date('d/m/Y', strtotime($additional_data['prepolicy']['tpEndDate'])) : $PreviousPolExpDt))
                                ],
                            ],
                            'PolicyEffectiveFrom' => [
                                '@value' => '',
                                '@attributes' => [
                                    ...
                                    'Value' => ($requestData->business_type == 'newbusiness' ? '' : ($premium_type == 'own_damage' ? date('d/m/Y', strtotime('+1 day',$additional_data['prepolicy']['tpStartDate'])) : $previous_policy_start_date))
                                ],
                            ],
                            'DateOfInspection' => [
                                '@value' => '',
                            ...
                            'PolicyNo' => [
                                ...
                                '@attributes' => [
                                    'Name' => 'Policy No',
                                    'Value' => ($requestData->business_type == 'newbusiness' ? '' :($premium_type == 'own_damage' ? $additional_data['prepolicy']['tpInsuranceNumber'] : $policyNo))
                                ],
                            ],
                            'PolicyYear' => [
                                '@value' => '',
                            ...
                            'InsurerName' => [
                                ...
                                '@attributes' => [
                                    'Name' => 'InsurerName',
                                    'Value' =>  ($requestData->business_type == 'newbusiness' ? '' : ($premium_type == 'own_damage' ? $additional_data['prepolicy']['tpInsuranceCompanyName'] : $proposal->insurance_company_name))
                                ],
                            ],
                            'InsurerAddress' => [
                                '@value' => '',
            ...
            $proposal_request =
                    [
                        'Authentication' =>
                        [
                            'WACode' =>  config('constants.IcConstants.universal_sompo.AUTH_CODE_SOMPO_CV_MISC'),#20000106
                            'WAAppCode' => config('constants.IcConstants.universal_sompo.AUTH_APPCODE_SOMPO_CV_MISC'), //AUTH_APPCODE_SOMPO_MOTOR,#30000108
                            'WAUserID' => config('constants.IcConstants.universal_sompo.WEB_USER_ID_SOMPO_CV_MISC'),   //WEB_USER_ID_SOMPO_MOTOR,#USER01
                            'WAUserPwd' => config('constants.IcConstants.universal_sompo.WEB_USER_PASSWORD_SOMPO_CV_MISC'), // WEB_USER_PASSWORD_SOMPO_MOTOR,#pass@123
                            'WAType'  => '0',
                                ...
                                'Risks' => [
                                        ...
                                        'VehicleModelCode' => [
                                                ...
                                                '@attributes' => [
                                                        ...
                                                        'Value' => $mmv_data->vehiclemodelcode
                                                ],
                                        ...
                                        'VehicleModel' => [
                                                ...
                                                '@attributes' => [
                                                        ...
                                                        'Name' => 'VehicleModel',
                                                        'Value' => $mmv_data->vehiclemodel . ' ' . $mmv_data->vehiclemodel
                                                ],
                                        ...
                                        'FuelType' => [
                                                ...
                                                '@attributes' => [
                                                        ...
                                                        'Name' => 'Fuel Type',
                                                        'Value' => $mmv_data->cnvm_fuel_type ///'Petrol'
                                                ],
                                        ...
                                        'SeatingCapacity' => [
                                                ...
                                                '@attributes' => [
                                                        ...
                                                        'Value' => $mmv_data->seatingcapacity
                                                ],
            ...
            $get_response = getWsData(config('constants.IcConstants.universal_sompo.END_POINT_URL_UNIVERSAL_SOMPO_CV_MISC'), $xmlQuoteRequest, 'universal_sompo', $additionData);
            ...
            if ($response) {
                ...
                $total_discount = (int)$ncb_discount + (int)$anti_theft_device_discount + (int)$automobile_association_discount + (int)$detariff_discount_amount + (int)$voluntary_deductable_amount + (int)$tppd_discount_amount;
                ...
                //         'od_premium' => round($total_OD_premium),
            ...
            $save = UserProposal::where('user_proposal_id', $proposal->user_proposal_id)->update($updateData);
                    ...
                    if($requestData->business_type == 'breakin' && !in_array($premium_type ,['third_party','third_party_breakin']) &&  $step != 'skip')
                    {
                        ...
                        $breakin_inspection_creation = [
                            ...
                            'VehicleType'=>'PC',
                            'Make'=>    $mmv_data->manufacturer,
                            'brand'=> $mmv_data->vehiclemodel . ' ' . $mmv_data->vehiclemodel,
                            'ModelYear'=> date('Y', strtotime('01-' . $requestData->manufacture_year)),
                            'FuelType'=> $mmv_data->cnvm_fuel_type,
