...
class futuregeneraliSubmitProposal extends Controller
{
    //
    public static function submit($proposal , $request)
    {
        ...
        // * proposal submit 
        // * call api 
        $get_response = getWsData(config('constants.IcConstants.future_generali.END_POINT_URL_FUTURE_GENERALI'), $proposal_array, 'future_generali', $additional_data);
        ...
        if (!empty($data)) 
        {
            ...
            FutureGeneraliPremiumDetailController::savePremiumDetails($get_response['webservice_id']);
                    ...
                    if($is_breakin == 'Y' && (!in_array($premium_type,['third_party','third_party_breakin'])))
                    {
