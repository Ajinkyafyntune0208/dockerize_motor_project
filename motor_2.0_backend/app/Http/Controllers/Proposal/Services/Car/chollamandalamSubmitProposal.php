...
//        $is_sapa = (!$is_cpa && isset($cpa_reason) && ($cpa_reason == 'cpaWithGreat15' || $cpa_reason == 'cpaWithOtherPolicy')) ? true : false;
        ...
        if($is_breakin){
            $product_id = config('constants.IcConstants.cholla_madalam.CHOLLA_MANDALAM_MOTOR_PRODUCT_ID');
        ...
        if($premium_type == 'third_party_breakin'){
            $product_id = config('constants.IcConstants.cholla_madalam.CHOLLA_MANDALAM_MOTOR_PRODUCT_ID_TP');
            $request_data['policy_type'] = 'third_party_breakin';
        }
        if($premium_type == 'own_damage_breakin'){
            $product_id = config('constants.IcConstants.cholla_madalam.CHOLLA_MANDALAM_MOTOR_PRODUCT_ID_OD');
