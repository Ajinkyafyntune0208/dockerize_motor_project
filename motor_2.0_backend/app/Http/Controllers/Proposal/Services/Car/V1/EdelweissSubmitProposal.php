    ...
    public static function submit($proposal, $request)
    {
        ...
        $current_ncb_rate = 0;
            ...
            if ($requestData->business_type == 'newbusiness')
                ...
                $get_response = getWsData(config('IC.EDELWEISS.V1.CAR.END_POINT_URL_TOKEN_GENERATION'),'', 'edelweiss',
                [
                    'enquiryId' => $enquiryId,
                    'requestMethod' =>'post',
        ...
        if(!$is_od){
            ...
            //quote req
            $quote_request_data = [
                //constants.IcConstants.edelweiss.EDELWEISS_CONTRACT_COMMISION_ID
                'commissionContractId' => config('IC.EDELWEISS.V1.CAR.CONTRACT_COMMISION_ID'),
                'channelCode'       => '002',
                'branch'            => config('IC.EDELWEISS.V1.CAR.BRANCH'), //constants.IcConstants.edelweiss.EDELWEISS_BRANCH
                'make'              => $mmv_data->make,
                ...
                'typeOfGrid'                        => config('IC.EDELWEISS.V1.CAR.GRID') , //constants.IcConstants.edelweiss.EDELWEISS_GRID
            ...
            $get_response = getWsData(config('IC.EDELWEISS.V1.CAR.END_POINT_URL_QUOTE_GENERATION'),$quote_request_data, 'edelweiss',
                        [
                            'enquiryId' => $enquiryId,
                            'requestMethod' =>'post',
                            'productName'  => $productData->product_name,
                ...
                // if($allowableDiscount < 300){
                    foreach($contractDetails as $key => $value)
                        ...
                        $proposal_request_data = [
                            ...
                            'branch'                          => config('IC.EDELWEISS.V1.CAR.BRANCH'), //constants.IcConstants.edelweiss.EDELWEISS_BRANCH
                            'agentEmail'                      => config('IC.EDELWEISS.V1.CAR.AGENT_EMAIL'), //constants.IcConstants.edelweiss.EDELWEISS_AGENT_EMAIL
                            'saleManagerCode'                 => config('IC.EDELWEISS.V1.CAR.SALES_MANAGER_CODE'), //constants.IcConstants.edelweiss.EDELWEISS_SALES_MANAGER_CODE
                            'saleManagerName'                 => config('IC.EDELWEISS.V1.CAR.SALES_MANGER_NAME'), //constants.IcConstants.edelweiss.EDELWEISS_SALES_MANGER_NAME
                        ...
                        //constants.IcConstants.edelweiss.END_POINT_URL_EDELWEISS_PROPOSAL_GENERATION
                        $get_response = getWsData(config('IC.EDELWEISS.V1.CAR.END_POINT_URL_PROPOSAL_GENERATION'),$proposal_request_data, 'edelweiss',
                        [
                            'enquiryId' => $enquiryId,
                            'requestMethod' =>'post',
                            'productName'  => $productData->product_name,
