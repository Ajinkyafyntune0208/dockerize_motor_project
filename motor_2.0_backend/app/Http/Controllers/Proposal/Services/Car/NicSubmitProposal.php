...
class NicSubmitProposal
{
    ...
    public static function submit($proposal, $request)
    {
        ...
        $addon['rti']               = ((!$is_liability && ($vehicle_age < 5) && ($return_to_invoice == 'Y')) ? true : false);
        $addon['key_replace']       = ((!$is_liability && ($vehicle_age < 5) && ($key_replacement == 'Y')) ? true : false);
        $addon['consumable']        = ((!$is_liability  && ($consumable == 'Y')) ? true : false);
        $addon['Loss_of_belonging'] = ((!$is_liability && ($vehicle_age < 5)  && ($loss_of_belongings == 'Y')) ? true : false);
        ...
        $quote_request_data['od_package'] = self::create_od_request($policy_date, $is_applicable, $registration_year, $is_new, $mmv_data, $is_liability,$amount);
        ...
        $quote_request_data['mmv'] = self::create_mmv_details_request($is_applicable, $addon, $mmv, $rto_data, $registration_year, $motor_manf_date);
        ...
        $quote_request_data['key_replace']      = self::create_lock_and_key_protect_request($policy_date, $registration_date, $mmv_data, $is_new);
        $quote_request_data['consumable']       = self::create_Consumables_Protect_request($policy_date, $registration_date, $mmv_data, $is_new);
        $quote_request_data['Loss_of_belonging'] = self::create_Loss_Of_Belonging_request($policy_date, $registration_date, $mmv_data, $is_new);
        ...
        $genPolicyInfoSOABO = [
            'fieldValueMap' => [
                'NIC_Amount' => '0',
                'NIC_Aware_of_Defects_Damages' => '1',
                'NIC_CIF_Gross_Premium_of_CIF_Policy' => $mmv->idv,
                'AnyLossOrDamage' => '2',
                'FleetDiscountRate' => '0',
                'NIC_Number_Fleet_Vehicles' => '4',
                'NIC_Driver_Clause' => '',
                'NIC_Limitations' => '',
                ...
                'NIC_NumberB' => $idv3,
                'NumberOfVehicles' => '0',
                'NIC_CIF_Sum_Insured' => '735832',
                'FleetDiscount' => '2',
                'NIC_Basis_of_Insurance_Policy_Level' => '1',
                'NIC_Declaration_Date'                  => ''
            ],
        ...
        if($addon['key_replace'])
        {
            array_push($quote_array['policySOABO']['insuredSOABOList'][0]['policyCtSOABOList'], $quote_request_data['key_replace']);
        }
        if($addon['consumable'])
        {
            array_push($quote_array['policySOABO']['insuredSOABOList'][0]['policyCtSOABOList'], $quote_request_data['consumable']);
        }
        if ($addon['Loss_of_belonging']) {
            array_push($quote_array['policySOABO']['insuredSOABOList'][0]['policyCtSOABOList'], $quote_request_data['Loss_of_belonging']);
        }
        ...
        if ($response) {
            ...
            $electrical_amount      = $is_applicable['motor_electric_accessories'] == true ? ($response['policyCtAcceSOABOList']['Electrical Accessories'] ?? 0) : 0;
            $non_electrical_amount  = $is_applicable['motor_non_electric_accessories'] == true ? ($response['policyCtAcceSOABOList']['Non Electrical Accessories'] ?? 0) : 0;
            $lpg_cng_amount         = '0';
            $lpg_cng_tp_amount      = '0';
            ...
            $cover_codes = [
                ...
                '700023465' => 'key_replace',
                '700023462' => 'consumable',
                '700024421' => 'Loss_of_belonging'
    ...
    public static function create_pa_request($policy_date, $pa_cover_details, $is_new, $mmv_data)
    {
        ...
        if($pa_cover_details['is_cpa']['is_applicable']){
            array_push(
                ...
                [
                    'fieldValueMap' => [
                        'NICBenefitNomineeName' => 'dfgdfgh',
                        'NICBenefitNomineeAge' => '34',
                        'NICBennefitRelationship' => 'hfgdf',
                    ],
    ...
    public static function create_legal_liability_tp_request($policy_date, $is_applicable, $is_new)
    {
        $legal_liability_tp_request = [
            ...
            'policyCtAcceSOABOList' => [
                ...
                1 => [
                    'fieldValueMap' => [
                        "IManufacturerSellingPrice" => "0",
                        'NICBenefitTPPDLimit' => '1',
                    ],
    ...
    public static function create_od_request($policy_date, $is_applicable, $registration_year, $is_new, $mmv_data, $is_liability,$amount)
    {
        // OD PACKAGE BLOCK
        $od_package['od'] = [
            'fieldValueMap' => [
        ...
        $od_package['electrical_accessories'] = [
            ...
            'interestDescription' => 'EA',
            'interestSi' => $amount['electrical'],
        ...
        $od_package['non_electrical_accessories'] = [
            ...
            'interestSi' =>  $amount['non_electrical'],
    ...
    public static function create_mmv_details_request($is_applicable, $addon, $mmv, $rto_data, $registration_year, $motor_manf_date)
    {
        ...
        $mmv_details_request = [
            ...
            'Handicapped'                   => '2',
            'ThreeWheeler'                  => '2',
            'InsuredCompulsoryExcess'       => '1000.0',
    ...
    public static function create_Loss_Of_Belonging_request($policy_date, $registration_date, $mmv_data, $is_new){

       $Loss_Of_Belonging = [
            "siType" => 1,
            "riskLevel" => 1,
            "excessDropDown" => 0,
            "updateTime" => "2023-04-17T10:40:27+05:30",
            "siOfCoverType" => 20000,
            "vesselOverageRate" => 0,
            "fieldValueMap" => [
                "NIC_Address_of_Veterinary_Doctor" => "10000"
            ],
            "basicRate" => 0,
            "coverTypeName" => "Loss of Belongings",
            "limitSiOfCoverType" => 20000,
            "haveSiFlag" => 1,
            "insuredId" => '',
            "coverTypeCode" => "LOBS",
            "coverTypeId" => 700024421,
            "policyCtId" => '',
            "liabilityStatus" => 1,
            "parentFlag" => 1,
            "effectiveDate" =>$policy_date['start'].'000',
            ...
            return $Loss_Of_Belonging;
    }

    public static function create_Consumables_Protect_request($policy_date, $registration_date, $mmv_data, $is_new){
        $Consumables_Protect = [
            
                "siOfCoverType"  => $mmv_data['idv'],
                "basicRate" => 0,
                "coverTypeName" => "Consumables Protect",
                "insuredId" => '',
                "limitSiOfCoverType" => 9999999999999.99,
                "coverTypeId" => 700023462,
                "policyCtId" => '',
                "effectiveDate" =>$policy_date['start'].'000',
                "expirtyDate" => $policy_date['end'].'000',
                "premiumIncome" => 0,
        ...
        return $Consumables_Protect;

    }

    public static function create_lock_and_key_protect_request($policy_date, $registration_date, $mmv_data, $is_new){
        $key_Replacement = [
            "fieldValueMap"  => [
                "BasicIDV" =>  $mmv_data['idv']
            ],
            "basicRate" => 0,
            "coverTypeName" => "Lock and Key Protect",
            "siOfCoverType" => $mmv_data['idv'],
            "limitSiOfCoverType" => '0',
            "insuredId" => "",
            "coverTypeId" => 700023465,
            "policyCtId"=> '',
            "effectiveDate" => $policy_date['start'].'000',
            "expirtyDate" => $policy_date['end'].'000',
