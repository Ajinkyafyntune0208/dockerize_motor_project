...
class DiscountConfigurationController extends Controller
{
    ...
    {
        if (!auth()->user()->can('discount_configuration.list')) {
        ...
        if ($request->method() == 'GET') {
            ...
            return view('admin_lte.discount-configuration.config-setting', compact('userCriteria', 'icList'));
        } else {
    ...
    public function globalConfig(Request $request)
    {
        ...
        if ($request->method() == 'GET') {
            ...
            return view('admin_lte.discount-configuration.global-config', compact('globalConfig'));
        } else {
            $validator = Validator::make($request->all(), [
    ...
    public function vehicleConfig(Request $request)
    {
        ...
        if ($request->method() == 'GET') {
            ...
            return view('admin_lte.discount-configuration.vehicle-config', compact('vehicleDiscount'));
        } else {
            $validator = Validator::make($request->all(), [
    ...
    public function icConfig(Request $request)
    {
        ...
        if ($request->method() == 'GET') {
            ...
            return view('admin_lte.discount-configuration.ic-config', compact('applicableIcs','discounts'));
        } else {
    ...
    public function activeConfig(Request $request)
    {
        ...
        if ($request->method() == 'GET') {
            ...
            ->first()->value ?? '';
            return view('admin_lte.discount-configuration.active-config', compact('configMethods', 'selectedConfigId'));
        } else {
    ...
    public function activityLogs(Request $request)
    {
        ...
        return view('admin_lte.discount-configuration.activity-logs', compact('activities', 'types'));
    }
