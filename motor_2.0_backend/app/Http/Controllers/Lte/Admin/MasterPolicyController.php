...
class MasterPolicyController extends Controller
{
    ...
    {
        DB::enableQueryLog();
        if (!auth()->user()->can('master_product.list')) {
        ...
        return view('admin_lte.master_policy.index', compact('master_policies','pstype', 'mcomp', 'mpremiums',));
    }
    ...
    {
        if (!auth()->user()->can('master_product.create')) {
            return response('unauthorized action', 401);
        }
        ...
        return view('admin_lte.master_policy.create', compact('master_product_sub_types', 'master_companies', 'master_premiums','previous_url'));
    }
    ...
    public function edit(Request $request,$policy_id)
    {
        ...
        return view('admin_lte.master_policy.edit', compact('master_product', 'master_policy', 'master_product_sub_types', 'master_companies', 'master_premiums','previous_url'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            if (!auth()->user()->can('master_product.edit')) {
                return abort(403, 'Unauthorized action.');
            }
