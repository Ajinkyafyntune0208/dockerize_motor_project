...
class CkycVerificationTypesController extends Controller
{
    ...
    {
        if (!auth()->user()->can('ckyc_verification_types.list')) {
        ...
        return view('admin_lte.ckyc_verification_types.index',compact('ckyc_verification_data','company_alias'));
    }
    ...
    public function create()
    {
        $data = CkycVerificationTypes::select('company_alias')->get();
        $company_alias = MasterCompany::whereNotIn('company_alias',$data)->get();
        return view('admin_lte.ckyc_verification_types.create', compact('company_alias'));
