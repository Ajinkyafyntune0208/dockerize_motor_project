...
class BrokerController extends Controller
{
    ...
    {
        $broker_details = BrokerDetail::orderby('id','desc')->get();
        return view('admin_lte.broker_details.index',compact('broker_details'));
    }
    ...
    {
        return view('admin_lte.broker_details.create');
    }
    ...
    {
        return view('admin_lte.broker_details.edit',['broker_details'=> $broker ]);
    }
