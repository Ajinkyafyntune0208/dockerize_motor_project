...
class ThirdPartyApiRequestResponsesController extends Controller
{
    ...
    {
        if (!auth()->user()->can('third_party_api_responses.list')) {
        ...
        return view('admin_lte.third_party_api_request_responses.index', compact('third_party_request_responses', 'third_party_names'));
    }
    ...
    public function show($id)
    {
        ...
        return view('admin_lte.third_party_api_request_responses.show',['tp'=> $tp]);
