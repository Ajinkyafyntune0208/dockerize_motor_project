...
class IcErrorHandllingController extends Controller
{
    ...
    {
        if (!auth()->user()->can('ic_error_handler.list')) {
        ...
        return view('admin_lte.ic-error-handling.index', compact('data', 'companies'));
    }
    ...
    public function create(Request $request)
    {
        ...
        if (isset($request->file) && $request->file == 'csv_file') {
            return view('admin_lte.ic-error-handling.upload', compact('companies'));
        }
        return view('admin_lte.ic-error-handling.create', compact('companies'));
    }
    ...
    public function edit($id)
    {
        ...
        //             ->orderBy('company_alias','asc')
        //             ->get();
        return view('admin_lte.ic-error-handling.edit', compact('edit_data'));
    }
