...
class MasterOccupationNameController extends Controller
{
    ...
    {
        if (!auth()->user()->can('master_occupation_name.list')) {
            abort(403, 'Unauthorized action.');
        }

        $occuption = MasterOccupationName::orderBy('id','desc')->get();
        return view('admin_lte.master-occupation-name.index', compact('occuption'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($occuption != null) {
            ...
            try{
                ...
                return redirect()->route('admin.master-occupation-name.index')->with([
                    'status' => 'Occupation name Added Successfully..!',
                    'class' => 'success',
                    ]);
                } catch (\Exception $e) {
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            return redirect()->route('admin.master-occupation-name.index')->with([
                'status' => 'Occupation name Updated Successfully..!',
                'class' => 'success',
                ]);
    ...
    public function destroy($id)
    {
        ...
        try {
            ...
            return redirect()->route('admin.master-occupation-name.index')->with([
                'status' => 'Occupation name Deleted..!',
                'class' => 'success',
                ]);
