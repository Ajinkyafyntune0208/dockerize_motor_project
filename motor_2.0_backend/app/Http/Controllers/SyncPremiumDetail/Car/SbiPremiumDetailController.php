...
class SbiPremiumDetailController extends Controller
{
    ...
    public static function savePremiumDetails($webserviceId)
    {
        try {
            ...
            $Consumables = 0;
            $anti_theft = 0;
            $OD_BasePremium = $final_od_premium = 0;
            ...
            $ncb_discount = $arr_premium['PolicyObject']['PolicyLobList'][0]['PolicyRiskList'][0]['OD_NCBAmount'] ?? 0;
            if ($is_anti_theft == '1') {
            ...
            $final_tp_premium = $Third_Party_Bodily_Injury + $CNG_LPG_Liability + $Legal_Liability_Paid_Drivers +  $PA_Paid_Driver + $PA_Unnamed_Passenger + $PA_Owner_Driver + $Legal_Liability_Employees;
            ...
            $final_gst_amount   = $final_payable_amount - $net_premium;
            ...
            $updatePremiumDetails = [
                ...
                "ll_paid_conductor" => 0,
                "ll_paid_cleaner" => 0,
                "ll_paid_employee" => $Legal_Liability_Employees,
