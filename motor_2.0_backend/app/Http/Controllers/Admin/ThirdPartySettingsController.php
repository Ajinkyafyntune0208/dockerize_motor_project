...
class ThirdPartySettingsController extends Controller
{
    ...
    {
        if (!auth()->user()->can('third_party.list')) {
            abort(403, 'Unauthorized action.');
        }

        $occuption = ThirdPartySetting::all();

        return view('third_party_settings.index', compact('occuption'));
    }
    ...
    {
        return view('third_party_settings.create');
    }
    ...
    public function edit($id)
    {
        ...
        return view('third_party_settings.edit',['configs'=> $configuration ]);
    }
    ...
    public function update(Request $request, ThirdPartySetting $thirdPartySetting)
    {
        ...
        try {
            ...
            if (!empty($data['api_headers'])) {
                $data['api_headers'] = json_decode($data['api_headers']);
            }
