...
class VahanServiceController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('vahan_service_new.index', compact('vahan_Services','cred'));
    }
    ...
    {
        return view('vahan_service_new.create');
    }
    public function dash()
    {
        return view('vahan_service_new.dash');
    }
    ...
    public function edit($id)
    {
        ...
        return view('vahan_service_new.edit', compact('vahan_service', 'id'));
    }
    ...
    public function credCrudPage(Request $request, $id)
    {
        ...
        if ($servic->status == 'Inactive') {
            ...
            return view('vahan_credentials.read', compact('vahan_services', 'service', 'id'));
        }
    }
    ...
    public function stageIndex()
    {
        ...
        return view('vahan_service_stage.index', compact('vahan_Services', 'J_stages'));
    }
    public function stageEdit($key, $v_type)
    {
        ...
        $Companies = DB::table('master_policy')
            ...
            ->groupBy('master_policy.insurance_company_id', 'master_company.company_shortname')
            ->get();
        $Ic_ids = [];
        ...
        if (sizeof($vahan_Services) == 0) {
            ...
            return view('vahan_service_stage.edit_new', compact('vahan_Services', 'collection', 'vahan_configs', 'Companies', 'v_type', 'j_val', 'key', 'items', 'string_ids', 'ic_ids', 'service_prio_lists'));
        }
    }
