...
class KafkaLogsController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if (!auth()->user()->can('kafka_log.list')){
        ...
        return view('admin.kafka-logs.index', compact('logs'));
    }
    ...
    public function show($id)
    {
        ...
        return view('admin.kafka-logs.show', compact('logsDetails'));
    }
    ...
    public function syncData(Request $request)
    {
        ...
        if (!auth()->user()->can('kafka-log.list')){
         abort(403, 'Unauthorized action.');
        } 
        ...
        ->get();
        return view('admin.kafka-logs.syncData', compact('logs','paymentStatus'));
    }
}
