...
class CkycNotAFailureCaseController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('ckyc_not_a_failure_cases.index', compact('CKYCNotAFailureCasess'));
    }
    ...
    {
        return view('ckyc_not_a_failure_cases.create');
    }
    ...
    public function edit($id)
    {
        ...
        return view('ckyc_not_a_failure_cases.edit', compact('CKYCNotAFailureCasess'));
    }
