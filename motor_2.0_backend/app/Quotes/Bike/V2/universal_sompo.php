...
{ 
    ...
    elseif($premium_type == 'third_party_breakin')
    {
        $premium_type = 'third_party'; 
    }
    elseif($premium_type == 'own_damage_breakin')
    {
    ...
    switch ($requestData->business_type) {
        ...
        case 'rollover':
            ...
            $prev_policy_start_date = Carbon::createFromFormat('d-m-Y', $requestData->previous_policy_expiry_date)->subYears(1)->format('d/m/Y');
            $policy_start_date = date('d/m/Y', strtotime(date('Y-m-d', strtotime('+1 day', strtotime($requestData->previous_policy_expiry_date)))));
            $prev_policy_end_date = Carbon::createFromFormat('d/m/Y', $prev_policy_start_date)->addYears(1)->subDays(1)->format('d/m/Y');
        ...
        case 'newbusiness':
            ...
            $prev_policy_end_date = $prev_policy_start_date = '';
        ...
        case 'breakin':
            ...
            $prev_policy_start_date = Carbon::createFromFormat('d-m-Y', $requestData->previous_policy_expiry_date)->subYears(1)->subDays(1)->format('d/m/Y');
            $prev_policy_end_date = Carbon::createFromFormat('d/m/Y', $prev_policy_start_date)->addYears(1)->format('d/m/Y');
    ...
    // try {
        ...
        if ($premium_type != 'third_party') {
            !empty($usgi_applicable_addons['return_to_invoice']) ? $usgi_applicable_addons['return_to_invoice'] : $usgi_applicable_addons['return_to_invoice'] = 'false';
            !empty($usgi_applicable_addons['engine_protector']) ? $usgi_applicable_addons['engine_protector'] : $usgi_applicable_addons['engine_protector'] = 'false';
            !empty($usgi_applicable_addons['consumable']) ? $usgi_applicable_addons['consumable'] : $usgi_applicable_addons['consumable'] = 'false';
        }
        ...
        if(in_array($requestData->policy_type , ['own_damage','own_damage_breakin']))
        {
            $tppolicystartdt = date('d/m/Y',strtotime($requestData->vehicle_register_date));
            $tppolicyenddt = Carbon::createFromFormat('d/m/Y', $tppolicystartdt)->addYears(5)->subDay(1)->format('d/m/Y');
        }
        elseif($requestData->business_type == 'rollover')
        {
            // $tppolicystartdt = date('d/m/Y',strtotime($requestData->previous_policy_expiry_date));
            $tppolicystartdt = Carbon::createFromFormat('d-m-Y', $requestData->previous_policy_expiry_date)->subYears(1)->format('d/m/Y');
            $tppolicyenddt = Carbon::createFromFormat('d/m/Y', $tppolicystartdt)->addYears(1)->subDay(1)->format('d/m/Y');
        }
        ...
        //Pass CPA as false in case of Company
                ...
                'PreviousPolDtlGroupData' => [
                    ...
                    'TPPolicyEffectiveTo' => [
                        ...
                        '@attributes' => [
                            ...
                            'Value' =>  in_array($requestData->policy_type,['own_damage','own_damage_breakin']) ? $tppolicyenddt : $prev_policy_end_date ,
                        ],
                    ],
                    'TPPolicyEffectiveFrom' => [
                        ...
                        '@attributes' => [
                            ...
                            'Value' => in_array($requestData->policy_type,['own_damage','own_damage_breakin']) ? $tppolicystartdt : $prev_policy_start_date ,
                        ],
                    ],
                    'TPInsurerPolicyNo' => [
                        '@value' => '',
                    ...
                    'TpInsurerName' => [
                        ...
                        '@attributes' => [
                            'Name' => 'TpInsurerName',
                            'Value' => 'ICICI LOMBARD GENERAL INSURANCE COMPANY LTD.',
                        ],
                    ],
                    'PolicyEffectiveTo' => [
                        '@value' => '',
                        '@attributes' => [
                            ...
                            'Value' =>   ($requestData->business_type == 'newbusiness')? null:$prev_policy_end_date
                        ],
                    ],
                    'PolicyEffectiveFrom' => [
                        '@value' => '',
                        '@attributes' => [
                            ...
                            'Value' => ($requestData->business_type == 'newbusiness')? null: $prev_policy_start_date 
                        ],
                    ],
                    'DateOfInspection' => [
                        '@value' => '',
        ...
        $covers_data_section = [
            ...
            '12' => [
                ...
                'Rate' => [
                    ...
                    '@attributes' => [
                        'Name' => 'Rate',
                        // 'Value' => ($requestData->business_type == 'newbusiness') ? 5 : 1,
                        'Value' => $cpa_tenure,
        ...
        $other_discount_section = [
            ...
            '5' => [
                ...
                'DiscountRate' => [
                    ...
                    '@attributes' => [
                        'Name' => 'Discount Rate',
                        'Value' => ((int) $requestData->previous_ncb) / 100
                    ],
                ],
                'SumInsured' => [
                    '@value' => '',
        ...
        if ($response) {
            ...
            $condition_3 = isset($filter_response['Root']['Authentication']['DocumentType']) && $filter_response['Root']['Authentication']['DocumentType'] == 'Quotation' && $filter_response['Root']['Errors']['ErrorCode'] != '0' && $filter_response['Root']['Errors']['ErrorCode'] != 'B001';
            ...
            $get_response = getWsData(config('IC.UNIVERSAL_SOMPO.V2.BIKE.ENDPOINT.URL'), $idvChangedQuoteXmlRequest, 'universal_sompo', $additionData);
        ...
        if ($newresponse) {
            ...
            foreach ($addonsData as $key => $add_on_cover) {
                if ($add_on_cover['AddonCoverGroups']['@attributes']['Value'] == 'Road side Assistance') {
                    ...
                    $rsa_res = $add_on_cover['Applicable']['@attributes']['Value'];
                }
            ...
            if($premium_type !== 'third_party')
            {
                ...
                // if($rsa < 1  && $rsa_res == 'True')
                // {
                //     $addons_data['in_built']['roadSideAssistance'] = (int) $rsa;
                // }
                // else
                // {
                //     $addons_data['additional']['roadSideAssistance'] = (int) $rsa;
                // }
                // dd($rsa,$rsa_res,$addons_data,$sss,$rsa < 1);
