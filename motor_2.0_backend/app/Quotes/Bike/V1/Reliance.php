    ...
    if (empty($mmv_data->ic_version_code) || $mmv_data->ic_version_code == '') {
        ...
        $premium_req_array = [
            ...
            "Cover" => [
                ...
                "IsElectricalItemFitted" => $electrical_accessories,
                "ElectricalItemsTotalSI" => $electrical_accessories_value,
                "IsNonElectricalItemFitted" => $non_electrical_accessories,
        ...
        else
        {
            $get_response = getWsData(
                config('IC.RELIANCE.V1.BIKE.END_POINT_URL_COVERAGE'),
                $premium_req_array,
                'reliance',
                [
                    ...
                    if ($premium_res_data) {
                        ...
                        if (trim($response->ErrorMessages) == '') {
                            ...
                            foreach ($response->lstPricingResponse as $k => $v) {
                                $value = round( (int) trim(str_replace('-', '', $v->Premium)));
                            ...
                            $final_od_premium = $basic_od + $other_discount;
                            ...
                            $checkvalue = abs(round($final_od_premium - $final_total_discount_for_loading_cal));
                            if($tp_only != 'true' && $checkvalue < 100 && $response->TotalODPremium <= 100)
                            {
                                $loading_amount = 100 - $checkvalue;
                            }
                            $final_net_premium = round($final_od_premium + $final_tp_premium);
                            ...
                            $data_response = [
                                ...
                                "Data" => [
                                    ...
                                    "basic_premium" => $final_od_premium,
