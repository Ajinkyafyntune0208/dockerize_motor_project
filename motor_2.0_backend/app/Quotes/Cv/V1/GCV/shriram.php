...
use App\Quotes\Cv\V1\GCV\shriram;
use DateTime;
...
function getV1GCVQuote($enquiryId, $requestData, $productData)
{  
...
//     }
    ...
    
    {
        ...
        $LLtoPaidDriverSI=$ElectricalaccessSI = $PAforUnnamedPassengerSI = $NonElectricalaccessSI = $PAforUnnamedPassenger = $PAPaidDriverConductorCleaner = $PAPaidDriverConductorCleanerSI = $externalCNGKITSI = $antitheft = $LimitOwnPremiseYN = $LimitedTPPDYN = $Electricalaccess = $NonElectricalaccess = $externalCNGKIT =  0;
    ...
    if($requestData->vehicle_owner_type = 'I'  ){
        ...
        $get_response = getWsData(config('IC.SHRIRAM.V1.GCV.QUOTE_URL'), $inputArray, 'shriram', $additional_data);
       //constants.IcConstants.shriram.SHRIRAM_GCV_CV_JSON_QUOTE_URL
