...
function getQuoteV2($enquiryId, $requestData, $productData)
{
    ...
    if (($requestData->ownership_changed ?? '') == 'Y') {
        if (!in_array($premium_type_array->premium_type_code, ['third_party', 'third_party_breakin'])) {
            $isInspectionApplicable = 'N';  // as discussed with Nirmal sir and as per git #33724
    ...
    {
        $fg_applicable_addons=applicable_addons($car_age, $with_zd,$productData->product_identifier);
    }
    else
    {
        $fg_applicable_addons=get_applicable_addons($with_zd,$productData->product_identifier);
    }     
...
// dd($fg_applicable_addons);
    ...
    try {
        $IsPos = 'N';
        if (config('IC.FUTURE_GENERALI.V2.CAR.REMOVE_POS_TAG_FOR_50_LAC_IDV_ENABLE') == 'Y') {
        ...
        if($premium_type == 'third_party' && ($requestData->business_type == 'newbusiness') || $risk_type == 'F13'){
            $cover_type = "CO";
        }
        ...
        // } else {
            $data = getWsData(config('IC.FUTURE_GENERALI.V2.CAR.END_POINT_URL'), $quote_array, 'future_generali', $additional_data);
        // }
        ...
        if ($data['response']) {
         ...
         //  dd($quote_output);
            ...
            {
                if(isset($quote_output['s:Body']['GetQuoteResponse']['GetQuoteResult']['Root']['Policy']['Status']) && $quote_output['s:Body']['GetQuoteResponse']['GetQuoteResult']['Root']['Policy']['Status'] == 'Fail'){
                    if (isset($quote_output['s:Body']['GetQuoteResponse']['GetQuoteResult']['Root']['Error'])) {
                        return [
                            'webservice_id' => $data['webservice_id'],
                            'table' => $data['table'],
                            'premium_amount' => 0,
                            'status'         => false,
                            'message'        => isset($quote_output['s:Body']['GetQuoteResponse']['GetQuoteResult']['Root']['ErrorMessage']['Root']['ErrorMessage']) ? trim(($quote_output['s:Body']['GetQuoteResponse']['GetQuoteResult']['Root']['ErrorMessage']['Root']['ErrorMessage'])) : trim(($quote_output['s:Body']['GetQuoteResponse']['GetQuoteResult']['Root']['ErrorMessage'] ?? $quote_output['s:Body']['GetQuoteResponse']['GetQuoteResult']['Root']['Error'])) 
                        ];
                    } elseif (isset($quote_output['s:Body']['GetQuoteResponse']['GetQuoteResult']['Root']['ErrorMessage'])) {
                        return [
                            'webservice_id' => $data['webservice_id'],
                            'table' => $data['table'],
                            'premium_amount' => 0,
                            'status'         => false,
                            'message'        => isset($quote_output['s:Body']['GetQuoteResponse']['GetQuoteResult']['Root']['ErrorMessage']['Root']['ErrorMessage']) ? trim(($quote_output['s:Body']['GetQuoteResponse']['GetQuoteResult']['Root']['ErrorMessage']['Root']['ErrorMessage'])) : trim($quote_output['s:Body']['GetQuoteResponse']['GetQuoteResult']['Root']['ErrorMessage']) 
                        ];
                    } elseif (isset($quote_output['s:Body']['GetQuoteResponse']['GetQuoteResult']['Root']['ValidationError'])) {
                        ...
                        return [
                            ...
                            'premium_amount' => 0,
                            'status'         => false,
                            'message'        => isset($quote_output['s:Body']['GetQuoteResponse']['GetQuoteResult']['Root']['ErrorMessage']['Root']['ErrorMessage']) ? trim(($quote_output['s:Body']['GetQuoteResponse']['GetQuoteResult']['Root']['ErrorMessage']['Root']['ErrorMessage'])) : trim(($quote_output['s:Body']['GetQuoteResponse']['GetQuoteResult']['Root']['ErrorMessage'] ?? $quote_output['s:Body']['GetQuoteResponse']['GetQuoteResult']['Root']['ValidationError']))
                        ];
                    }
                }
                $enq=$quote_output['s:Body']['GetQuoteResponse']['GetQuoteResult']['Root']['Client'];
              
                $data_quotation=['quotation_no'=>$enq['QuotationNo'],
                'client_id'=>$enq['ClientId']];

                $client=json_encode($data_quotation);
                $value= DB::table('user_proposal')
            ...
            if (isset($quote_output['s:Body']['GetQuoteResponse']['GetQuoteResult']['Root']['Policy'])) {
                ...
                if ($quote_output['Status'] == 'Fail') {
                    ...
                    if (config('IC.FUTURE_GENERALI.V2.CAR.REMOVE_POS_TAG_FOR_50_LAC_IDV_ENABLE') == 'Y' && $idv >= 5000000) {
                    ...
                    if ($data['response']) {
                        ...
                        if (isset($quote_output['s:Body']['GetQuoteResponse']['GetQuoteResult']['Root']['Policy'])) {
                            ...
                            $quote_output = $quote_output['s:Body']['GetQuoteResponse']['GetQuoteResult'];
                    ...
                    $addInconvenienceAllowance=false;
                ...
                //    dd($quote_output);
                    ...
                    //   dd(($cover['Code'] == 'STRSA') && ($cover['Type'] == 'OD'));
                        ...
                        elseif (($cover['Code'] == 'IMT1') && ($cover['Type'] == 'OD')) {
                            $geog_Extension_OD_Premium = $value;
                        }
                        elseif (($cover['Code'] == 'IMT1') && ($cover['Type'] == 'TP')) {
                            $geog_Extension_TP_Premium = $value;
                        }
                        ...
                        $applicable_addons=['zeroDepreciation','consumables','roadSideAssistance','keyReplace','lopb'];
                        ...
                        $applicable_addons=['zeroDepreciation','consumables','engineProtector','roadSideAssistance','keyReplace','lopb'];
                        ...
                        $applicable_addons=['zeroDepreciation','consumables','tyreSecure','roadSideAssistance','keyReplace','lopb'];
                    }
                    elseif (($cover['Code'] == 'ZDCET') && ($cover['Type'] == 'OD')) {
                        if((int)$value == 0)
                        {
                            ...
                            $applicable_addons=['zeroDepreciation','consumables','engineProtector','tyreSecure','roadSideAssistance','keyReplace','lopb'];
                        }
                        elseif (($cover['Code'] == 'ZCETR') && ($cover['Type'] == 'OD')) {
                            ...
                            $applicable_addons=['zeroDepreciation','consumables','engineProtector','tyreSecure','returnToInvoice','roadSideAssistance','keyReplace','lopb'];
                        }
                        ...
                        elseif (($cover['Code'] == 'RSPBK') && ($cover['Type'] == 'OD')) {
                            ...
                            $applicable_addons=['roadSideAssistance','keyReplace','lopb'];
                        }
                        elseif (($cover['Code'] == 'STZDP') && ($cover['Type'] == 'OD')) {
                            ...
                            $applicable_addons=['zeroDepreciation','roadSideAssistance','keyReplace','lopb'];
                        ...
                        else
                        {
                                ...
                                // $applicable_addons=['ncbProtection'];
                                // array_push($applicable_addons, 'ncbProtection');
                        }


                        }
                        elseif(($cover['Code'] == 'STINC') && ($cover['Type'] == 'OD'))
                        {
                            if((int)$value == 0)
                            {
                            ...
                            $addInconvenienceAllowance = true;
                            $InconvenienceAllowance = (int)$value;
                            $applicable_addons=['InconvenienceAllowance'];
                        }
                        }

                    }
                                        
                    if($addncbProtectionInAddons && in_array($productData->product_identifier ,['STZDP']))
                    {
                        $selected_addons_data['in_built']['ncbProtection'] = (int)$ncbProptectionValue;
                    }
                    if($addInconvenienceAllowance)
                    {
                        $selected_addons_data['additional']['InconvenienceAllowance'] = (int)$InconvenienceAllowance;
                    }
                    ...
                    $total_tp = $tp_premium + $liability + $pa_unnamed + $lpg_cng_tp_amount + $legal_liability_to_employee + $liability_IMT29;
                    ...
                    //$applicable_addons=["roadSideAssistance", "ncbProtection", "tyreSecure", "zeroDepreciation", "engineProtector", "consumables", "keyReplace","returnToInvoice","lopb"];
                     ...
                     $other_addons = [
                        'LegalLiabilityToEmployee' => $liability_IMT29 ?? 0,
                     ];
                     if(empty($liability_IMT29))
                     {
                    ...
                    //  dd($data_response);
                     ...
                     if (!empty($liability_IMT29)) {
                         $data_response['Data']['LegalLiabilityToEmployee'] = $liability_IMT29 ?? 0;
                     }
...
function applicable_addons($age, $with_zd,$identifier)
{
    $ZCETR = $ZDCET = $ZDCNT = $STNCB = $ZDCNE = $ZDCNS = $STZDP = $STRSA = $RSPBK = 'N';
        ...
        if(in_array($identifier,['STZDP', 'STZDP']))
        {
            if($age <= 7)
            {
                array_push($applicable_addons,['CoverCode' => $identifier]);
...
function get_applicable_addons($with_zd,$identifier)
{
    $ZCETR = $ZDCET = $ZDCNT = $STNCB = $ZDCNE = $ZDCNS = $STZDP = $STRSA = $RSPBK = 'N';
        $applicable_addons = [];
        $error_message = [];
