...
function getRenewalQuote($enquiryId, $requestData, $productData)
{
    ...
    $vehicle_age = $bike_age = floor($age / 12);
    ...
    $renewal_fetch_array = [
        'PrevPolicyNumber' => $user_proposal->previous_policy_number,
        'EngineNo' => '',
        'ChassisNo' => '',
        'RegistrationNo' => $user_proposal->vehicale_registration_number,
        'PrevPolicyEndDate' => '',
        'ProductCode' => '',
    ...
    if (!isset($renewal_response->PolicyDetails->ErrorMessages->ErrMessages)) {
        ...
        $vehicle_manf = Carbon::parse($Vehicle->ManufactureDate);
        $vehicle_manf_month = $vehicle_manf->month;
        $vehicle_manf_year = $vehicle_manf->year;
        ...
        $Countries = 'false';
        foreach($CoverDetails as $k=>$val){
            if($val->CoverName == "PA to Unnamed Passenger"){
                $nop = $val->NoOfPersons;
            }
        }
        if ($selected_addons && $selected_addons->additional_covers != NULL && $selected_addons->additional_covers != '') {
            ...
            foreach ($additional_covers as $value) {
                ...
                if ($value['name'] == 'Unnamed Passenger PA Cover') {
                    ...
                    $PAToUnNamedPassenger_NoOfItems = $nop;
    ...
    $premium_req_array =
        [
            ...
            'Policy' => [
                'BusinessType' => $Policy->BusinessTypeid,
                'AgentCode' => 'Direct',
                'AgentName' => 'Direct',
                'Branch_Name' => 'Direct',
            ...
            'Risk' => [
                ...
                'ManufactureMonth'                    => $vehicle_manf_month,
                'ManufactureYear'                     => $vehicle_manf_year,
            ...
            if (isset($coverage_res_data->LstAddonCovers)) {
                ...
                if ($premium_res_data) {
                    ...
                    if (trim($response->ErrorMessages) == '') {
                        ...
                        $CurrentNCBId = ($CurrentNCBId !== false) ? $ncb_master[$CurrentNCBId] : null;
                        ...
                        $other_discount = 0;
                        $final_od_premium = $basic_od + $electrical_accessories + $non_electrical_accessories + $lpg_cng;
                        $final_tp_premium = $tppd + $liabilities + $pa_paid_driver + $pa_unnamed + $lpg_cng_tp;
                        ...
                        $data_response = [
                            ...
                            'Data' => [
                                ...
                                'selected_addon'            => [],
                                'showroom_price'            => 0,
                                'fuel_type'                 => $Vehicle->TypeOfFuel,
                                'ncb_discount'              => $CurrentNCBId,
