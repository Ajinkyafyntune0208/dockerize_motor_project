...
class icici_lombard
{
    public static function getRenewalData($enquiryId, &$value)
    {
        ...
        $getResponse = getWsData(config('constants.IcConstants.icici_lombard.ICICI_LOMBARD_TOKEN_GENERATION_URL_BIKE'), http_build_query($tokenParam), 'icici_lombard', $additionData);
